var Module = function() {
    ...
    return function(r) {
        ...
        function(e) {
            ...
            var t = "waflash.data";
            "function" != typeof r.locateFilePackage || r.locateFile || (r.locateFile = r.locateFilePackage,
            p("warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)"));
            var n = r.locateFile ? r.locateFile(t, "") : t
              , i = e.remote_package_size;
            e.package_uuid;
            var a, o, u, s, c = null, l = r.getPreloadedPackage ? r.getPreloadedPackage(n, i) : null;
            function f() {
                function t(e, r) {
                    if (!e)
                        throw r + (new Error).stack
                }
                function n(e, r, t) {
                    this.start = e,
                    this.end = r,
                ...
                for (var i = e.files, a = 0; a < i.length; ++a)
                    new n(i[a].start,i[a].end,i[a].audio).open("GET", i[a].filename);
                function o(i) {
                    r.finishedDataFileDownloads++,
                    t(i, "Loading data file failed."),
                    t(i instanceof ArrayBuffer, "bad input to processPackageData");
                    var a = new Uint8Array(i);
                    n.prototype.byteArray = a;
                    for (var o = e.files, u = 0; u < o.length; ++u)
            ...
            s.onprogress = function(e) {
                var t = a
                  , n = o;
                if (e.total && (n = e.total),
                e.loaded) {
                    s.addedTotal ? r.dataFileDownloads[t].loaded = e.loaded : (s.addedTotal = !0,
                    ...
                    i = Math.ceil(i * r.expectedDataFileDownloads / c),
                    r.setStatus && r.setStatus("Downloading data... (" + u + "/" + i + ")")
                } else
                    r.dataFileDownloads || r.setStatus && r.setStatus("Downloading data...")
            }
            ,
            ...
            ,
            s.onload = function(e) {
                if (!(200 == s.status || 304 == s.status || 206 == s.status || 0 == s.status && s.response))
            ...
            ,
            s.send(null)),
            r.calledRun ? f() : (r.preRun || (r.preRun = []),
            r.preRun.push(f))
        }({
            files: [{
            ...
            package_uuid: "93c987a8-1695-4f36-a191-e7fcefb83c62"
        });
        var n, i = {};
        for (n in r)
            r.hasOwnProperty(n) && (i[n] = r[n]);
        var a, o, u, s, c = [], l = "./this.program", f = function(e, r) {
            throw r
        }, d = "";
        ...
        function g(e) {
            ...
            default:
                ...
                if ("i" === e[0]) {
                    ...
                    return D(r % 8 == 0, "getNativeTypeSize invalid bits " + r + ", type " + e),
                    r / 8
                }
                return 0
            }
        ...
        function k(e, r, t, n) {
            ...
            case "i64":
                he = [r >>> 0, (_e = r,
                +ae(_e) >= 1 ? _e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0 : 0)],
                q[e >> 2] = he[0],
                q[e + 4 >> 2] = he[1];
                break;
            case "float":
        ...
        r.noExitRuntime && (y = r.noExitRuntime),
        ...
        function T(e, r, t) {
            for (var n = r + t, i = r; e[i] && !(i >= n); )
                ++i;
            if (i - r > 16 && e.subarray && P)
                return P.decode(e.subarray(r, i));
            for (var a = ""; r < i; ) {
                var o = e[r++];
                if (128 & o) {
                    var u = 63 & e[r++];
                    if (192 != (224 & o)) {
                        var s = 63 & e[r++];
                        if ((o = 224 == (240 & o) ? (15 & o) << 12 | u << 6 | s : (7 & o) << 18 | u << 12 | s << 6 | 63 & e[r++]) < 65536)
        ...
        var U, j, O, G, z, q, Q, V, X;
        function H(e) {
            U = e,
            r.HEAP8 = j = new Int8Array(e),
            r.HEAP16 = G = new Int16Array(e),
            r.HEAP32 = q = new Int32Array(e),
            r.HEAPU8 = O = new Uint8Array(e),
            r.HEAPU16 = z = new Uint16Array(e),
            r.HEAPU32 = Q = new Uint32Array(e),
            r.HEAPF32 = V = new Float32Array(e),
            r.HEAPF64 = X = new Float64Array(e)
        }
        var W = 1055504
        ...
        function de(e) {
            ce++,
            r.monitorRunDependencies && r.monitorRunDependencies(ce)
        }
        function me(e) {
            if (ce--,
            r.monitorRunDependencies && r.monitorRunDependencies(ce),
            0 == ce && (null !== le && (clearInterval(le),
            le = null),
            fe)) {
                var t = fe;
                fe = null,
        ...
        ve(be) || (ge = be,
        be = r.locateFile ? r.locateFile(ge, d) : d + ge);
        var we = {
            2558: function(e) {
                const r = L(e);
                Pe.mkdir(r),
            ...
            8869: function(e, t) {
                ...
                n && (n.wafSelectionChangedByEngine = !0,
            ...
            889370: function(e) {
                ...
                function(e, r, t, n) {
                    ...
                    if (o = 3 == t ? n : [Zr, wt, v][t](Math.max(a, u ? 1 : r.length)),
                    i) {
                        var s;
                        for (n = o,
                        D(0 == (3 & o)),
                    ...
                    if ("i8" === u)
                        return e.subarray || e.slice ? O.set(e, o) : O.set(new Uint8Array(e), o),
                        o;
                    for (var c, l, f, d = 0; d < a; ) {
                        var m = e[d];
                        0 !== (c = u || r[d]) ? ("i64" == c && (c = "i32"),
                        k(o + d, m, c),
                        f !== c && (l = g(c),
                        f = c),
                        d += l) : d++
            ...
            925260: function(e, t, n) {
                var i = e
                  , a = t
                  , o = n;
                r.SDL2 || (r.SDL2 = {});
                var u = r.SDL2;
                u.ctxCanvas !== r.canvas && (u.ctx = r.createContext(r.canvas, !1, !0),
                u.ctxCanvas = r.canvas),
                u.w === i && u.h === a && u.imageCtx === u.ctx || (u.image = u.ctx.createImageData(i, a),
                u.w = i,
                u.h = a,
                u.imageCtx = u.ctx);
                var s, c = u.image.data, l = o >> 2, f = 0;
                if ("undefined" != typeof CanvasPixelArray && c instanceof CanvasPixelArray)
                    ...
                    u.data32Data !== c && (u.data32 = new Int32Array(c.buffer),
                    u.data8 = new Uint8Array(c.buffer));
                    var m = u.data32;
                    s = m.length,
                    m.set(q.subarray(l, l + s));
                    var p = u.data8
                      , v = 3
                      , g = v + 4 * s;
                    if (s % 8 == 0)
                ...
                return u.ctx.putImageData(u.image, 0, 0),
                0
            },
            926739: function(e, r, t, n, i) {
                var a = e
                  , o = r
                  , u = t
                  , s = n
                ...
                l.width = a,
                l.height = o;
                var f, d = l.getContext("2d"), m = d.createImageData(a, o), p = m.data, v = c >> 2, g = 0;
                if ("undefined" != typeof CanvasPixelArray && p instanceof CanvasPixelArray)
                    ...
                    f = h.length,
                    h.set(q.subarray(v, v + f))
                }
                d.putImageData(m, 0, 0);
                var b = 0 === u && 0 === s ? "url(" + l.toDataURL() + "), auto" : "url(" + l.toDataURL() + ") " + u + " " + s + ", auto"
                  , y = Zr(b.length + 1);
                return B(b, y, b.length + 1),
                y
            },
            927728: function(e) {
                return r.canvas && (r.canvas.style.cursor = L(e)),
                0
            },
            927821: function() {
            ...
            929737: function(e) {
                ...
                var t = r.SDL2;
                return e ? t.capture = {} : t.audio = {},
                t.audioContext || ("undefined" != typeof AudioContext ? t.audioContext = new AudioContext : "undefined" != typeof webkitAudioContext && (t.audioContext = new webkitAudioContext)),
                void 0 === t.audioContext ? -1 : 0
            },
            930220: function() {
                return r.SDL2.audioContext.sampleRate
            },
            930290: function(e, t, n, i) {
                var a = r.SDL2
                  , o = function(r) {
                    void 0 !== a.capture.silenceTimer && (clearTimeout(a.capture.silenceTimer),
                    ...
                    a.capture.scriptProcessorNode.onaudioprocess = function(e) {
                        void 0 !== a && void 0 !== a.capture && (e.outputBuffer.getChannelData(0).fill(0),
            ...
            931942: function(e, t, n, i) {
                ...
                a.audio.scriptProcessorNode.onaudioprocess = function(e) {
                    void 0 !== a && void 0 !== a.audio && (a.audio.currentOutputBuffer = e.outputBuffer,
                    h("vi", n, [i]))
                }
                ,
            ...
            932352: function(e, t) {
                for (var n = r.SDL2, i = n.capture.currentCaptureBuffer.numberOfChannels, a = 0; a < i; ++a) {
                    ...
                    if (o.length != t)
                        throw "Web Audio capture buffer length mismatch! Destination size: " + o.length + " samples vs expected " + t + " samples!";
                    if (1 == i)
                        for (var u = 0; u < t; ++u)
                            k(e + 4 * u, o[u], "float");
                    else
                        for (u = 0; u < t; ++u)
                            k(e + 4 * (u * i + a), o[u], "float")
                }
            },
            932957: function(e, t) {
                for (var n = r.SDL2, i = n.audio.currentOutputBuffer.numberOfChannels, a = 0; a < i; ++a) {
                    ...
                    if (o.length != t)
                        throw "Web Audio output buffer length mismatch! Destination size: " + o.length + " samples vs expected " + t + " samples!";
                    for (var u = 0; u < t; ++u)
                        o[u] = V[e + (u * i + a << 2) >> 2]
                }
            },
            933437: function(e) {
                var t = r.SDL2;
                if (e) {
                    if (void 0 !== t.capture.silenceTimer && clearTimeout(t.capture.silenceTimer),
                    void 0 !== t.capture.stream) {
                        for (var n = t.capture.stream.getAudioTracks(), i = 0; i < n.length; i++)
                            t.capture.stream.removeTrack(n[i]);
                    ...
                    void 0 !== t.capture.mediaStreamNode && (t.capture.mediaStreamNode.disconnect(),
                    t.capture.mediaStreamNode = void 0),
                    void 0 !== t.capture.silenceBuffer && (t.capture.silenceBuffer = void 0),
                    t.capture = void 0
                } else
                    null != t.audio.scriptProcessorNode && (t.audio.scriptProcessorNode.disconnect(),
                    t.audio.scriptProcessorNode = void 0),
                    t.audio = void 0;
                void 0 !== t.audioContext && void 0 === t.audio && void 0 === t.capture && (t.audioContext.close(),
        ...
        var ke, Ce = {
            ...
            relative: function(e, r) {
                ...
                e = Se.resolve(e).substr(1),
                r = Se.resolve(r).substr(1);
            ...
            default_tty_ops: {
                ...
                put_char: function(e, r) {
                    null === r || 10 === r ? (m(T(e.output, 0)),
                    e.output = []) : 0 != r && e.output.push(r)
                },
                flush: function(e) {
                    e.output && e.output.length > 0 && (m(T(e.output, 0)),
                    e.output = [])
                }
            },
            default_tty1_ops: {
                put_char: function(e, r) {
                    null === r || 10 === r ? (p(T(e.output, 0)),
                    e.output = []) : 0 != r && e.output.push(r)
                },
                flush: function(e) {
                    e.output && e.output.length > 0 && (p(T(e.output, 0)),
                    e.output = [])
                }
            }
        }, Fe = {
            ...
            createNode: function(e, r, t, n) {
                ...
                return Pe.isDir(i.mode) ? (i.node_ops = Fe.ops_table.dir.node,
                i.stream_ops = Fe.ops_table.dir.stream,
                i.contents = {}) : Pe.isFile(i.mode) ? (i.node_ops = Fe.ops_table.file.node,
                i.stream_ops = Fe.ops_table.file.stream,
                i.usedBytes = 0,
                i.contents = null) : Pe.isLink(i.mode) ? (i.node_ops = Fe.ops_table.link.node,
                i.stream_ops = Fe.ops_table.link.stream) : Pe.isChrdev(i.mode) && (i.node_ops = Fe.ops_table.chrdev.node,
                i.stream_ops = Fe.ops_table.chrdev.stream),
            ...
            node_ops: {
                getattr: function(e) {
                    var r = {};
                    return r.dev = Pe.isChrdev(e.mode) ? e.id : 1,
                    r.ino = e.id,
                    r.mode = e.mode,
                    r.nlink = 1,
                    r.uid = 0,
                    r.gid = 0,
                    r.rdev = e.rdev,
                    Pe.isDir(e.mode) ? r.size = 4096 : Pe.isFile(e.mode) ? r.size = e.usedBytes : Pe.isLink(e.mode) ? r.size = e.link.length : r.size = 0,
                ...
                setattr: function(e, r) {
                    ...
                    void 0 !== r.size && Fe.resizeFileStorage(e, r.size)
                },
                lookup: function(e, r) {
            ...
            stream_ops: {
                read: function(e, r, t, n, i) {
                    ...
                    if (i >= e.node.usedBytes)
                        return 0;
                    var o = Math.min(e.node.usedBytes - i, n);
                    if (o > 8 && a.subarray)
                        r.set(a.subarray(i, i + o), t);
                    else
                        for (var u = 0; u < o; u++)
                            r[t + u] = a[i + u];
                    return o
                ...
                write: function(e, r, t, n, i, a) {
                    ...
                    r.subarray && (!o.contents || o.contents.subarray)) {
                        if (a)
                            return o.contents = r.subarray(t, t + n),
                            o.usedBytes = n,
                            n;
                        if (0 === o.usedBytes && 0 === i)
                            return o.contents = r.slice(t, t + n),
                            o.usedBytes = n,
                            n;
                        if (i + n <= o.usedBytes)
                            return o.contents.set(r.subarray(t, t + n), i),
                            n
                    }
                    if (Fe.expandFileStorage(o, i + n),
                    o.contents.subarray && r.subarray)
                        o.contents.set(r.subarray(t, t + n), i);
                    else
                        for (var u = 0; u < n; u++)
                            o.contents[i + u] = r[t + u];
                    return o.usedBytes = Math.max(o.usedBytes, i + n),
                    n
                },
                llseek: function(e, r, t) {
                    var n = r;
                    if (1 === t ? n += e.position : 2 === t && Pe.isFile(e.node.mode) && (n += e.node.usedBytes),
                    n < 0)
                        throw new Pe.ErrnoError(28);
                    return n
                },
                allocate: function(e, r, t) {
                    Fe.expandFileStorage(e.node, r + t),
                    e.node.usedBytes = Math.max(e.node.usedBytes, r + t)
                },
                mmap: function(e, r, t, n, i, a, o) {
                    if (!Pe.isFile(e.node.mode))
                        throw new Pe.ErrnoError(43);
                    var u, s, c = e.node.contents;
                    if (2 & o || c.buffer !== r.buffer) {
                        (i > 0 || i + n < c.length) && (c = c.subarray ? c.subarray(i, i + n) : Array.prototype.slice.call(c, i, i + n)),
                        s = !0;
                        var l = r.buffer == j.buffer;
                        if (!(u = Zr(n)))
            ...
            indexedDB: function() {
                ...
                D(e, "IDBFS used, but indexedDB not supported"),
                e
            },
            DB_VERSION: 21,
            ...
            getDB: function(e, r) {
                ...
                if (!t)
                    return r("Unable to connect to IndexedDB");
            ...
            getLocalSet: function(e, r) {
                ...
                for (var a = Pe.readdir(e.mountpoint).filter(n).map(i(e.mountpoint)); a.length; ) {
                    ...
                    Pe.isDir(o.mode) && a.push.apply(a, Pe.readdir(u).filter(n).map(i(u))),
                    t[u] = {
                        timestamp: o.mtime
                    }
                }
            ...
            loadLocalEntry: function(e, r) {
                ...
                return Pe.isDir(t.mode) ? r(null, {
                    timestamp: t.mtime,
                    mode: t.mode
                }) : Pe.isFile(t.mode) ? (n.contents = Fe.getFileDataAsTypedArray(n),
                r(null, {
                    timestamp: t.mtime,
                    mode: t.mode,
                    contents: n.contents
            ...
            storeLocalEntry: function(e, r, t) {
                try {
                    ...
                    Pe.chmod(e, r.mode),
                    Pe.utime(e, r.timestamp, r.timestamp)
                } catch (e) {
                    return t(e)
                }
                t(null)
            ...
            reconcile: function(e, r, t) {
                ...
                Object.keys(e.entries).forEach((function(t) {
                    var a = e.entries[t]
                      , o = r.entries[t];
                    (!o || a.timestamp > o.timestamp) && (i.push(t),
                    n++)
                }
                ));
                var a = [];
            ...
            lookupPath: function(e, r) {
                ...
                for (var i = Ce.normalizeArray(e.split("/").filter((function(e) {
                    ...
                    if (s && r.parent)
                        break;
                    if (a = Pe.lookupNode(a, i[u]),
                    o = Ce.join2(o, i[u]),
                    Pe.isMountpoint(a) && (!s || s && r.follow_mount) && (a = a.mounted.root),
                    !s || r.follow)
                        for (var c = 0; Pe.isLink(a.mode); ) {
                            var l = Pe.readlink(o);
                            if (o = Se.resolve(Ce.dirname(o), l),
                            a = Pe.lookupPath(o, {
            ...
            hashAddNode: function(e) {
                ...
                e.name_next = Pe.nameTable[r],
                Pe.nameTable[r] = e
            },
            hashRemoveNode: function(e) {
                var r = Pe.hashName(e.parent.id, e.name);
                if (Pe.nameTable[r] === e)
                    Pe.nameTable[r] = e.name_next;
                else
            ...
            mayDelete: function(e, r, t) {
                ...
                if (t) {
                    if (!Pe.isDir(n.mode))
                        return 54;
                    if (Pe.isRoot(n) || Pe.getPath(n) === Pe.cwd())
                        return 10
                } else if (Pe.isDir(n.mode))
                    return 31;
                return 0
            },
            ...
            createStream: function(e, r, t) {
                Pe.FSStream || (Pe.FSStream = function() {}
                ,
            ...
            syncfs: function(e, r) {
                ...
                e = !1),
                Pe.syncFSRequests++,
                Pe.syncFSRequests > 1 && p("warning: " + Pe.syncFSRequests + " FS.syncfs operations in flight at once, probably just doing extra work");
                var t = Pe.getMounts(Pe.root.mount)
                  , n = 0;
                function i(e) {
                    return Pe.syncFSRequests--,
                    r(e)
                }
                function a(e) {
                    if (e)
            ...
            unmount: function(e) {
                ...
                Object.keys(Pe.nameTable).forEach((function(e) {
                    for (var r = Pe.nameTable[e]; r; ) {
                        var t = r.name_next;
                        -1 !== i.indexOf(r.mount) && Pe.destroyNode(r),
                        r = t
                    }
                }
                )),
            ...
            symlink: function(e, r) {
                ...
                var n = Ce.basename(r)
                  , i = Pe.mayCreate(t, n);
                if (i)
                    throw new Pe.ErrnoError(i);
                if (!t.node_ops.symlink)
                    throw new Pe.ErrnoError(63);
                return t.node_ops.symlink(t, n, e)
            },
            rename: function(e, r) {
                var t, n, i = Ce.dirname(e), a = Ce.dirname(r), o = Ce.basename(e), u = Ce.basename(r);
                try {
                    t = Pe.lookupPath(e, {
                        parent: !0
                    }).node,
                ...
                if (!t || !n)
                    throw new Pe.ErrnoError(44);
                if (t.mount !== n.mount)
                    throw new Pe.ErrnoError(75);
                var s, c = Pe.lookupNode(t, o), l = Se.relative(e, a);
                if ("." !== l.charAt(0))
                    throw new Pe.ErrnoError(28);
                if ("." !== (l = Se.relative(r, i)).charAt(0))
                    throw new Pe.ErrnoError(55);
                try {
                    s = Pe.lookupNode(n, u)
                } catch (e) {}
                if (c !== s) {
                    ...
                    if (d)
                        throw new Pe.ErrnoError(d);
                    if (d = s ? Pe.mayDelete(n, u, f) : Pe.mayCreate(n, u))
                        throw new Pe.ErrnoError(d);
                    if (!t.node_ops.rename)
                        throw new Pe.ErrnoError(63);
                    if (Pe.isMountpoint(c) || s && Pe.isMountpoint(s))
                        throw new Pe.ErrnoError(10);
                    if (n !== t && (d = Pe.nodePermissions(t, "w")))
                        throw new Pe.ErrnoError(d);
                    try {
            ...
            truncate: function(e, r) {
                ...
                if (!t.node_ops.setattr)
                    throw new Pe.ErrnoError(63);
                if (Pe.isDir(t.mode))
                    throw new Pe.ErrnoError(31);
                if (!Pe.isFile(t.mode))
                    throw new Pe.ErrnoError(28);
                var n = Pe.nodePermissions(t, "w");
                if (n)
                    throw new Pe.ErrnoError(n);
            ...
            open: function(e, t, n, i, a) {
                ...
                var o;
                if (n = void 0 === n ? 438 : n,
                n = 64 & (t = "string" == typeof t ? Pe.modeStringToFlags(t) : t) ? 4095 & n | 32768 : 0,
                "object" == typeof e)
                    o = e;
                else {
                    e = Ce.normalize(e);
                ...
                if (64 & t)
                    if (o) {
                        if (128 & t)
                            throw new Pe.ErrnoError(20)
                    } else
                        o = Pe.mknod(e, n, 0),
                        u = !0;
                if (!o)
                    throw new Pe.ErrnoError(44);
                if (Pe.isChrdev(o.mode) && (t &= -513),
                65536 & t && !Pe.isDir(o.mode))
                    throw new Pe.ErrnoError(54);
                if (!u) {
                    var s = Pe.mayOpen(o, t);
                    if (s)
                        throw new Pe.ErrnoError(s)
                }
                512 & t && Pe.truncate(o, 0),
                t &= -131713;
                ...
                !r.logReadFiles || 1 & t || (Pe.readFiles || (Pe.readFiles = {}),
                e in Pe.readFiles || (Pe.readFiles[e] = 1,
                p("FS.trackingDelegate error on read file: " + e)));
                try {
                    if (Pe.trackingDelegate.onOpenFile) {
                        var l = 0;
                        1 != (2097155 & t) && (l |= Pe.tracking.openFlags.READ),
                        0 != (2097155 & t) && (l |= Pe.tracking.openFlags.WRITE),
                        Pe.trackingDelegate.onOpenFile(e, l)
                    }
                } catch (r) {
            ...
            allocate: function(e, r, t) {
                ...
                if (!e.stream_ops.allocate)
                    throw new Pe.ErrnoError(138);
                e.stream_ops.allocate(e, r, t)
            },
            mmap: function(e, r, t, n, i, a, o) {
                if (0 != (2 & a) && 0 == (2 & o) && 2 != (2097155 & e.flags))
            ...
            readFile: function(e, r) {
                ...
                var t, n = Pe.open(e, r.flags), i = Pe.stat(e).size, a = new Uint8Array(i);
                return Pe.read(n, a, 0, i, 0),
                "utf8" === r.encoding ? t = T(a, 0) : "binary" === r.encoding && (t = a),
                Pe.close(n),
                t
            },
            ...
            chdir: function(e) {
                ...
                if (null === r.node)
                    throw new Pe.ErrnoError(44);
                if (!Pe.isDir(r.node.mode))
                    throw new Pe.ErrnoError(54);
                var t = Pe.nodePermissions(r.node, "x");
                if (t)
                    throw new Pe.ErrnoError(t);
            ...
            createDefaultDevices: function() {
                ...
                De.register(Pe.makedev(5, 0), De.default_tty_ops),
                De.register(Pe.makedev(6, 0), De.default_tty1_ops),
                ...
                Pe.createDevice("/dev", "random", e),
                Pe.createDevice("/dev", "urandom", e),
                Pe.mkdir("/dev/shm"),
            ...
            createStandardStreams: function() {
                r.stdin ? Pe.createDevice("/dev", "stdin", r.stdin) : Pe.symlink("/dev/tty", "/dev/stdin"),
                r.stdout ? Pe.createDevice("/dev", "stdout", null, r.stdout) : Pe.symlink("/dev/tty", "/dev/stdout"),
                r.stderr ? Pe.createDevice("/dev", "stderr", null, r.stderr) : Pe.symlink("/dev/tty1", "/dev/stderr");
                Pe.open("/dev/stdin", "r"),
                Pe.open("/dev/stdout", "w"),
                Pe.open("/dev/stderr", "w")
            },
            ensureErrnoError: function() {
                ...
                [44].forEach((function(e) {
                    ...
                    Pe.genericErrors[e].stack = "<generic error, no stack>"
                }
                )))
            },
            staticInit: function() {
            ...
            findObject: function(e, r) {
                ...
                return t.exists ? t.object : (xe(t.error),
                null)
            },
            ...
            createLazyFile: function(e, r, t, n, i) {
                ...
                a.prototype.cacheLength = function() {
                    ...
                    var r, n = Number(e.getResponseHeader("Content-length")), i = (r = e.getResponseHeader("Accept-Ranges")) && "bytes" === r, a = (r = e.getResponseHeader("Content-Encoding")) && "gzip" === r, o = 1048576;
                    i || (o = n);
                    var u = this;
                    u.setDataGetter((function(e) {
                        ...
                        void 0 === u.chunks[e] && (u.chunks[e] = function(e, r) {
                            ...
                            if (i.open("GET", t, !1),
                            n !== o && i.setRequestHeader("Range", "bytes=" + e + "-" + r),
                ...
                o.contents ? u.contents = o.contents : o.url && (u.contents = null,
                u.url = o.url),
            ...
            createPreloadedFile: function(e, t, n, i, a, o, u, s, c, l) {
                ...
                function d(n) {
                    function d(r) {
                        l && l(),
                        s || Pe.createDataFile(e, t, r, i, a, c),
                        o && o(),
                        me()
                    }
                    var m = !1;
                ...
                de(),
                "string" == typeof n ? Be.asyncLoad(n, (function(e) {
                    d(e)
                }
                ), u) : d(n)
            },
            ...
            saveFilesToDB: function(e, r, t) {
                ...
                i.onupgradeneeded = function() {
                    m("creating db"),
                    i.result.createObjectStore(Pe.DB_STORE_NAME)
                }
                ,
                i.onsuccess = function() {
            ...
            loadFilesFromDB: function(e, r, t) {
                ...
                i.onsuccess = function() {
                    ...
                    e.forEach((function(e) {
                        var r = o.get(e);
                        r.onsuccess = function() {
                            Pe.analyzePath(e).exists && Pe.unlink(e),
                            Pe.createDataFile(Ce.dirname(e), Ce.basename(e), r.result, !0, !0, !0),
                            ++u + s == c && l()
                        }
                        ,
                        r.onerror = function() {
            ...
            doStat: function(e, r, t) {
                try {
                    ...
                    if (e && e.node && Ce.normalize(r) !== Ce.normalize(Pe.getPath(e.node)))
                        return -54;
                    throw e
                }
                return q[t >> 2] = n.dev,
                ...
                q[t + 28 >> 2] = n.rdev,
                q[t + 32 >> 2] = 0,
                he = [n.size >>> 0, (_e = n.size,
                +ae(_e) >= 1 ? _e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0 : 0)],
                q[t + 40 >> 2] = he[0],
                q[t + 44 >> 2] = he[1],
                q[t + 48 >> 2] = 4096,
                q[t + 52 >> 2] = n.blocks,
                q[t + 56 >> 2] = n.atime.getTime() / 1e3 | 0,
                q[t + 60 >> 2] = 0,
                q[t + 64 >> 2] = n.mtime.getTime() / 1e3 | 0,
                q[t + 68 >> 2] = 0,
                q[t + 72 >> 2] = n.ctime.getTime() / 1e3 | 0,
                q[t + 76 >> 2] = 0,
                he = [n.ino >>> 0, (_e = n.ino,
                +ae(_e) >= 1 ? _e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0 : 0)],
                q[t + 80 >> 2] = he[0],
            ...
            doMkdir: function(e, r) {
                return "/" === (e = Ce.normalize(e))[e.length - 1] && (e = e.substr(0, e.length - 1)),
                Pe.mkdir(e, r, 0),
                0
            },
            ...
            doAccess: function(e, r) {
                ...
                2 & r && (n += "w"),
                1 & r && (n += "x"),
                n && Pe.nodePermissions(t, n) ? -2 : 0
            },
            doDup: function(e, r, t) {
                var n = Pe.getStream(t);
                return n && Pe.close(n),
                Pe.open(e, r, 0, t, t).fd
            },
        ...
        function Le(e, r) {
            if (Be.mainLoop.timingMode = e,
            Be.mainLoop.timingValue = r,
            !Be.mainLoop.func)
                return 1;
            if (0 == e)
        ...
        function Ie(e, t, n, i, a) {
            var o;
            y = !0,
            D(!Be.mainLoop.func, "emscripten_set_main_loop: there can only be one main loop function at once: call emscripten_cancel_main_loop to cancel the previous one before setting a new one with different parameters."),
            Be.mainLoop.func = e,
            Be.mainLoop.arg = i,
            o = void 0 !== i ? function() {
                r.dynCall_vi(e, i)
            ...
            if (Be.mainLoop.runner = function() {
                if (!S)
                    if (Be.mainLoop.queue.length > 0) {
                        ...
                        if (r.func(r.arg),
                        Be.mainLoop.remainingBlockers) {
                            var t = Be.mainLoop.remainingBlockers
                              , n = t % 1 == 0 ? t - 1 : Math.floor(t);
                            r.counted ? Be.mainLoop.remainingBlockers = n : (n += .5,
                            Be.mainLoop.remainingBlockers = (8 * t + n) / 9)
                        }
                        if (console.log('main loop blocker "' + r.name + '" took ' + (Date.now() - e) + " ms"),
                        Be.mainLoop.updateStatus(),
                        u < Be.mainLoop.currentlyRunningMainloop)
                            return;
                        setTimeout(Be.mainLoop.runner, 0)
                    } else
                        u < Be.mainLoop.currentlyRunningMainloop || (Be.mainLoop.currentFrameNumber = Be.mainLoop.currentFrameNumber + 1 | 0,
                        1 == Be.mainLoop.timingMode && Be.mainLoop.timingValue > 1 && Be.mainLoop.currentFrameNumber % Be.mainLoop.timingValue != 0 ? Be.mainLoop.scheduler() : (0 == Be.mainLoop.timingMode && (Be.mainLoop.tickStartTime = ke()),
                        Be.mainLoop.runIter(o),
                        u < Be.mainLoop.currentlyRunningMainloop || ("object" == typeof SDL && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(),
                        Be.mainLoop.scheduler())))
            }
            ,
            a || (t && t > 0 ? Le(0, 1e3 / t) : Le(1, 1),
            Be.mainLoop.scheduler()),
            n)
                throw "unwind"
        }
        ...
        var Be = {
            mainLoop: {
                ...
                resume: function() {
                    ...
                    var e = Be.mainLoop.timingMode
                      ...
                      , t = Be.mainLoop.func;
                    Be.mainLoop.func = null,
                    Ie(t, 0, !1, Be.mainLoop.arg, !0),
                    Le(e, r),
                    Be.mainLoop.scheduler()
                },
                ...
                runIter: function(e) {
                    if (!S) {
                        ...
                        try {
                            ...
                            if (e instanceof xt)
                                return;
                            throw e && "object" == typeof e && e.stack && p("exception thrown: " + [e, e.stack]),
                            e
                        }
            ...
            workers: [],
            init: function() {
                if (r.preloadPlugins || (r.preloadPlugins = []),
                !Be.initted) {
                    Be.initted = !0;
                    try {
                        new Blob,
                        Be.hasBlobConstructor = !0
                    } catch (e) {
                        Be.hasBlobConstructor = !1,
                        console.log("warning: no blob constructor, cannot create blobs with mimetypes")
                    }
                    Be.BlobBuilder = "undefined" != typeof MozBlobBuilder ? MozBlobBuilder : "undefined" != typeof WebKitBlobBuilder ? WebKitBlobBuilder : Be.hasBlobConstructor ? null : console.log("warning: no BlobBuilder"),
                    Be.URLObject = "undefined" != typeof window ? window.URL ? window.URL : window.webkitURL : void 0,
                    r.noImageDecoding || void 0 !== Be.URLObject || (console.log("warning: Browser does not support creating object URLs. Built-in browser image decoding will not be available."),
                    r.noImageDecoding = !0);
                    var e = {
                        ...
                        handle: function(e, t, n, i) {
                            ...
                            if (Be.hasBlobConstructor)
                                try {
                                    ...
                                    _("Blob constructor present but fails: " + e + "; falling back to blob builder")
                                }
                            if (!a) {
                            ...
                            s.onload = function() {
                                ...
                                r.preloadedImages[t] = i,
                                Be.URLObject.revokeObjectURL(u),
                                n && n(e)
                            }
                            ,
                            s.onerror = function(e) {
                    ...
                    var t = {
                        ...
                        handle: function(e, t, n, i) {
                            ...
                            l.onerror = function(r) {
                                a || (console.log("warning: browser could not fully decode audio " + t + ", trying slower base64 approach"),
                    ...
                    r.elementPointerLock && n.addEventListener("click", (function(e) {
                        !Be.pointerLock && r.canvas.requestPointerLock && (r.canvas.requestPointerLock(),
                        e.preventDefault())
                    }
                    ), !1))
                }
            ...
            createContext: function(e, t, n, i) {
                ...
                if (t) {
                    ...
                    a = e.getContext("2d");
                return a ? (n && (t || D(void 0 === jr, "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"),
                r.ctx = a,
                t && Ue.makeContextCurrent(o),
                r.useWebGL = t,
                Be.moduleContextCreatedCallbacks.forEach((function(e) {
                    e()
                }
                )),
                Be.init()),
            ...
            requestFullscreen: function(e, t) {
                Be.lockPointer = e,
                Be.resizeCanvas = t,
                void 0 === Be.lockPointer && (Be.lockPointer = !0),
                void 0 === Be.resizeCanvas && (Be.resizeCanvas = !1);
                var n = r.canvas;
                function i() {
                    Be.isFullscreen = !1;
                    var e = n.parentNode;
                    (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === e ? (n.exitFullscreen = Be.exitFullscreen,
                    Be.lockPointer && n.requestPointerLock(),
                    Be.isFullscreen = !0,
                    Be.resizeCanvas ? Be.setFullscreenCanvasSize() : Be.updateCanvasDimensions(n)) : (e.parentNode.insertBefore(n, e),
                    e.parentNode.removeChild(e),
                    Be.resizeCanvas ? Be.setWindowedCanvasSize() : Be.updateCanvasDimensions(n)),
                    r.onFullScreen && r.onFullScreen(Be.isFullscreen),
                    r.onFullscreen && r.onFullscreen(Be.isFullscreen)
                }
                Be.fullscreenHandlersInstalled || (Be.fullscreenHandlersInstalled = !0,
            ...
            exitFullscreen: function() {
                return !!Be.isFullscreen && ((document.exitFullscreen || document.cancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen || document.webkitCancelFullScreen || function() {}
                ).apply(document, []),
                !0)
            },
            nextRAF: 0,
            ...
            requestAnimationFrame: function(e) {
                ...
                Be.fakeRequestAnimationFrame)(e) : requestAnimationFrame(e)
            },
            ...
            resumeAsyncCallbacks: function() {
                if (Be.allowAsyncCallbacks = !0,
                Be.queuedAsyncCallbacks.length > 0) {
                    var e = Be.queuedAsyncCallbacks;
                    Be.queuedAsyncCallbacks = [],
                    e.forEach((function(e) {
                        e()
                    }
                    ))
            ...
            calculateMouseEvent: function(e) {
                if (Be.pointerLock)
                    "mousemove" != e.type && "mozMovementX"in e ? Be.mouseMovementX = Be.mouseMovementY = 0 : (Be.mouseMovementX = Be.getMovementX(e),
                    Be.mouseMovementY = Be.getMovementY(e)),
                    "undefined" != typeof SDL ? (Be.mouseX = SDL.mouseX + Be.mouseMovementX,
                    Be.mouseY = SDL.mouseY + Be.mouseMovementY) : (Be.mouseX += Be.mouseMovementX,
                    Be.mouseY += Be.mouseMovementY);
                else {
                    ...
                    if ("touchstart" === e.type || "touchend" === e.type || "touchmove" === e.type) {
                        ...
                        if ("touchstart" === e.type)
                            Be.lastTouches[u.identifier] = l,
                            Be.touches[u.identifier] = l;
                        else if ("touchend" === e.type || "touchmove" === e.type) {
                            var f = Be.touches[u.identifier];
                            f || (f = l),
                            Be.lastTouches[u.identifier] = f,
                            Be.touches[u.identifier] = l
                        }
                        return
                    }
                    ...
                    d *= n / t.width,
                    m *= i / t.height,
                    Be.mouseMovementX = d - Be.mouseX,
                    Be.mouseMovementY = m - Be.mouseY,
                    Be.mouseX = d,
                    Be.mouseY = m
                }
            },
            asyncLoad: function(e, r, t, n) {
                var i = n ? "" : "al " + e;
                o(e, (function(t) {
                    D(t, 'Loading data file "' + e + '" failed (no arrayBuffer).'),
                    r(new Uint8Array(t)),
                    i && me()
                }
                ), (function(r) {
            ...
            setCanvasSize: function(e, t, n) {
                var i = r.canvas;
                Be.updateCanvasDimensions(i, e, t),
                n || Be.updateResizeListeners()
            },
            windowedWidth: 0,
            windowedHeight: 0,
            setFullscreenCanvasSize: function() {
                ...
                Be.updateCanvasDimensions(r.canvas),
                Be.updateResizeListeners()
            },
            ...
            updateCanvasDimensions: function(e, t, n) {
                ...
                var i = t
                  , a = n;
                if (r.forcedAspectRatio && r.forcedAspectRatio > 0 && (i / a < r.forcedAspectRatio ? i = Math.round(a * r.forcedAspectRatio) : a = Math.round(i / r.forcedAspectRatio)),
                ...
                Be.resizeCanvas ? (e.width != i && (e.width = i),
                ...
                void 0 !== e.style && (i != t || a != n ? (e.style.setProperty("width", i + "px", "important"),
            ...
            getNextWgetRequestHandle: function() {
                ...
                return Be.nextWgetRequestHandle++,
                e
            }
        }
          , Re = {
            ...
            scheduleContextAudio: function(e) {
                if (1 !== Be.mainLoop.timingMode || "visible" == document.visibilityState)
                    for (var r in e.sources)
                        Re.scheduleSourceAudio(e.sources[r])
            },
            scheduleSourceAudio: function(e, r) {
                if ((1 !== Be.mainLoop.timingMode || "visible" == document.visibilityState) && 4114 === e.state) {
                    ...
                    for (var u = t + r, s = 0; n < u; ) {
                        ...
                        if (0 === c.length) {
                            if (++s === e.bufQueue.length)
                                break
                        } else {
                            var l;
                            (l = e.context.audioCtx.createBufferSource()).buffer = c.audioBuf,
                            l.playbackRate.value = e.playbackRate,
                            (c.audioBuf._loopStart || c.audioBuf._loopEnd) && (l.loopStart = c.audioBuf._loopStart,
                            l.loopEnd = c.audioBuf._loopEnd);
                            var f = 0;
                            4136 === e.type && e.looping ? (f = Number.POSITIVE_INFINITY,
                            l.loop = !0,
                            c.audioBuf._loopStart && (l.loopStart = c.audioBuf._loopStart),
                            c.audioBuf._loopEnd && (l.loopEnd = c.audioBuf._loopEnd)) : f = (c.audioBuf.duration - i) / e.playbackRate,
                            l._startOffset = i,
                            l._duration = f,
                            l._skipCount = s,
                            s = 0,
                            l.connect(e.gain),
                            void 0 !== l.start ? (n = Math.max(n, e.context.audioCtx.currentTime),
                            l.start(n, i)) : void 0 !== l.noteOn && (n = Math.max(n, e.context.audioCtx.currentTime),
                            l.noteOn(n)),
                            l._startTime = n,
                            e.audioQueue.push(l),
                            n += f
            ...
            updateSourceTime: function(e) {
                ...
                if (4114 !== e.state)
                    return r;
                isFinite(e.bufStartTime) || (e.bufStartTime = r - e.bufOffset / e.playbackRate,
                e.bufOffset = 0);
                for (var t = 0; e.audioQueue.length; ) {
                    var n = e.audioQueue[0];
                    if (e.bufsProcessed += n._skipCount,
            ...
            setSourceState: function(e, r) {
                4114 === r ? (4114 !== e.state && 4116 != e.state || (e.bufsProcessed = 0,
                e.bufOffset = 0),
                Re.stopSourceAudio(e),
                e.state = 4114,
                e.bufStartTime = Number.NEGATIVE_INFINITY,
                Re.scheduleSourceAudio(e)) : 4115 === r ? 4114 === e.state && (Re.updateSourceTime(e),
                Re.stopSourceAudio(e),
                e.state = 4115) : 4116 === r ? 4113 !== e.state && (e.state = 4116,
                e.bufsProcessed = e.bufQueue.length,
                e.bufStartTime = Number.NEGATIVE_INFINITY,
                e.bufOffset = 0,
                Re.stopSourceAudio(e)) : 4113 === r && 4113 !== e.state && (e.state = 4113,
                e.bufsProcessed = 0,
                e.bufStartTime = Number.NEGATIVE_INFINITY,
                e.bufOffset = 0,
                Re.stopSourceAudio(e))
            ...
            updateContextGlobal: function(e) {
                for (var r in e.sources)
                    Re.updateSourceGlobal(e.sources[r])
            },
            updateSourceGlobal: function(e) {
                var r = e.panner;
                if (r)
                    switch (r.refDistance = e.refDistance,
            ...
            updateListenerSpace: function(e) {
                ...
                for (var t in r.positionX ? (r.positionX.value = e.listener.position[0],
                r.positionY.value = e.listener.position[1],
                r.positionZ.value = e.listener.position[2]) : r.setPosition(e.listener.position[0], e.listener.position[1], e.listener.position[2]),
                r.forwardX ? (r.forwardX.value = e.listener.direction[0],
                ...
                r.upZ.value = e.listener.up[2]) : r.setOrientation(e.listener.direction[0], e.listener.direction[1], e.listener.direction[2], e.listener.up[0], e.listener.up[1], e.listener.up[2]),
                e.sources)
            ...
            updateSourceSpace: function(e) {
                if (e.panner) {
                    ...
                    if (e.relative) {
                        ...
                        m *= b,
                        p *= b;
                        var y = (g *= b = h(v, g, _)) * p - (_ *= b) * m
                          , w = _ * d - (v *= b) * p
                          , E = v * m - g * d
                          , x = a
                          , k = o
                          , C = u;
                        a = x * (y *= b = h(y, w, E)) + k * (v = m * (E *= b) - p * (w *= b)) + C * d,
                        o = x * w + k * (g = p * y - d * E) + C * m,
                        u = x * E + k * (_ = d * w - m * y) + C * p,
                        t = (x = t) * y + (k = n) * v + (C = i) * d,
                        n = x * w + k * g + C * m,
                        i = x * E + k * _ + C * p,
                        t += c,
                    ...
                    r.positionX ? (r.positionX.value = t,
                    r.positionY.value = n,
                    r.positionZ.value = i) : r.setPosition(t, n, i),
                    r.orientationX ? (r.orientationX.value = a,
                    r.orientationY.value = o,
                    r.orientationZ.value = u) : r.setOrientation(a, o, u);
            ...
            updateSourceRate: function(e) {
                if (4114 === e.state) {
                    ...
                    if (!t)
                        return;
                    r = 4136 === e.type && e.looping ? Number.POSITIVE_INFINITY : (t.buffer.duration - t._startOffset) / e.playbackRate,
                    t._duration = r,
            ...
            getGlobalParam: function(e, r) {
                ...
                default:
                    return Re.currentCtx.err = 40962,
                    null
                }
            },
                    ...
                    if (i && 0 !== r)
                        if (null !== n)
                            ...
                            case 8196:
                                ...
                                break;
                            case 8213:
                                if (n[0] < 0 || n[0] > i.length || n[1] < 0 || n[1] > i.Length || n[0] >= n[1])
                                    return void (Re.currentCtx.err = 40963);
                                if (i.refCount > 0)
                                    return void (Re.currentCtx.err = 40964);
                                i.audioBuf && (i.audioBuf._loopStart = n[0] / i.frequency,
            ...
            getSourceParam: function(e, r, t) {
                ...
                if (!n)
                    return Re.currentCtx.err = 40961,
                    null;
                switch (t) {
                case 514:
                    return n.relative;
                ...
                case 4133:
                    return (i = Re.sourceTell(n)) > 0 && (i *= n.bufQueue[0].frequency),
                    i;
                case 4134:
                    var i;
                    return (i = Re.sourceTell(n)) > 0 && (i *= n.bufQueue[0].frequency * n.bufQueue[0].bytesPerSample),
                    i;
                case 4135:
                    return n.type;
                case 4628:
                    return n.spatialize;
                case 8201:
                    for (var a = 0, o = 0, u = 0; u < n.bufQueue.length; u++)
                        a += n.bufQueue[u].length,
                        0 !== n.bufQueue[u].id && (o = n.bufQueue[u].bytesPerSample * n.bufQueue[u].channels);
                    return a * o;
                case 8202:
                    for (a = 0,
                    u = 0; u < n.bufQueue.length; u++)
                        a += n.bufQueue[u].length;
                    return a;
                case 8203:
                        ...
                        if (null !== n)
                            ...
                            case 4103:
                                if (1 === n) {
                                    ...
                                    4136 === i.type && i.audioQueue.length > 0 && ((a = i.audioQueue[0]).loop = !1,
                                    a._duration = i.bufQueue[0].audioBuf.duration / i.playbackRate,
                            ...
                            case 4105:
                                if (4114 === i.state || 4115 === i.state)
                                    return void (Re.currentCtx.err = 40964);
                                if (0 === n) {
                                    for (var u = 0; u < i.bufQueue.length; u++)
                                        i.bufQueue[u].refCount--;
                                    i.bufQueue.length = 1,
                                    i.bufQueue[0] = Re.buffers[0],
                                    i.bufsProcessed = 0,
                                    i.type = 4144
                                } else {
                                    if (!(d = Re.buffers[n]))
                                        return void (Re.currentCtx.err = 40963);
                                    for (u = 0; u < i.bufQueue.length; u++)
                                        i.bufQueue[u].refCount--;
                                    i.bufQueue.length = 0,
                                    d.refCount++,
                                    i.bufQueue = [d],
                                ...
                                Re.initSourcePanner(i),
                                Re.scheduleSourceAudio(i);
                                break;
                            case 4106:
                                if (!Number.isFinite(n) || n < 0)
                                    return void (Re.currentCtx.err = 40963);
                                ...
                                break;
                            case 4109:
                                if (!Number.isFinite(n) || n < 0 || n > Math.min(i.maxGain, 1))
                                    return void (Re.currentCtx.err = 40963);
                                i.minGain = n;
                                break;
                            case 4110:
                                if (!Number.isFinite(n) || n < Math.max(0, i.minGain) || n > 1)
                                    return void (Re.currentCtx.err = 40963);
                                i.maxGain = n;
                                break;
                            case 4128:
                            ...
                            case 53248:
                                ...
                                case 53254:
                                    i.distanceModel = n,
                                    Re.currentCtx.sourceDistanceModel && Re.updateContextGlobal(Re.currentCtx);
                                    break;
                                default:
                                    return void (Re.currentCtx.err = 40963)
                                }
            ...
            requireValidCaptureDevice: function(e, r) {
                if (0 === e)
                    return Re.alcErr = 40961,
                    null;
                var t = Re.captures[e];
                return t ? t.mediaStreamError ? (Re.alcErr = 40961,
                null) : t : (Re.alcErr = 40961,
                null)
            }
        };
        function Me(e, r, t) {
        ...
        var Ne = {
            ...
            chooseConfig: function(e, r, t, n, i) {
                ...
                return t && n || i ? (i && (q[i >> 2] = 1),
                t && n > 0 && (q[t >> 2] = 62002),
                Ne.setErrorCode(12288),
                1) : (Ne.setErrorCode(12300),
                0)
            }
        };
        var Ue = {
            ...
            unpackAlignment: 4,
            init: function() {
                for (var e = new Float32Array(Ue.MINI_TEMP_BUFFER_SIZE), r = 0; r < Ue.MINI_TEMP_BUFFER_SIZE; r++)
                    Ue.miniTempBufferFloatViews[r] = e.subarray(0, r + 1);
                var t = new Int32Array(Ue.MINI_TEMP_BUFFER_SIZE);
                for (r = 0; r < Ue.MINI_TEMP_BUFFER_SIZE; r++)
                    Ue.miniTempBufferIntViews[r] = t.subarray(0, r + 1)
            },
            recordError: function(e) {
                Ue.lastError || (Ue.lastError = e)
            },
            getNewId: function(e) {
                for (var r = Ue.counter++, t = e.length; t < r; t++)
                    e[t] = null;
                return r
            },
            ...
            registerContext: function(e, r) {
                ...
                Ue.contexts[t] = n,
                (void 0 === r.enableExtensionsByDefault || r.enableExtensionsByDefault) && Ue.initExtensions(n),
                t
            },
            makeContextCurrent: function(e) {
                return Ue.currentContext = Ue.contexts[e],
                r.ctx = jr = Ue.currentContext && Ue.currentContext.GLctx,
                !(e && !jr)
            },
            ...
            deleteContext: function(e) {
                Ue.currentContext === Ue.contexts[e] && (Ue.currentContext = null),
                "object" == typeof je && je.removeAllHandlersOnTarget(Ue.contexts[e].GLctx.canvas),
                Ue.contexts[e] && Ue.contexts[e].GLctx.canvas && (Ue.contexts[e].GLctx.canvas.GLctxObject = void 0),
                Ue.contexts[e] = null
            },
            initExtensions: function(e) {
                if (e || (e = Ue.currentContext),
            ...
            populateUniformTable: function(e) {
                ...
                }, n = t.uniforms, i = jr.getProgramParameter(r, 35718), a = 0; a < i; ++a) {
                    var o = jr.getActiveUniform(r, a)
                      , u = o.name;
                    t.maxUniformLength = Math.max(t.maxUniformLength, u.length + 1),
                    "]" == u.slice(-1) && (u = u.slice(0, u.lastIndexOf("[")));
                    var s = jr.getUniformLocation(r, u);
                    if (s) {
                        ...
                        for (var l = 1; l < o.size; ++l) {
                            var f = u + "[" + l + "]";
                            s = jr.getUniformLocation(r, f),
                            c = Ue.getNewId(Ue.uniforms),
                            Ue.uniforms[c] = s
                        }
                    }
                }
        ...
        var je = {
            ...
            registerRemoveEventListeners: function() {
                je.removeEventListenersRegistered || (ee.push(je.removeAllEventListeners),
            ...
            deferCall: function(e, r, t) {
                ...
                for (var i in je.deferredCalls) {
                    var a = je.deferredCalls[i];
                    if (a.targetFunction == e && n(a.argsList, t))
                        return
                }
            ...
            removeDeferredCalls: function(e) {
                for (var r = 0; r < je.deferredCalls.length; ++r)
                    je.deferredCalls[r].targetFunction == e && (je.deferredCalls.splice(r, 1),
                    --r)
            },
            ...
            removeAllHandlersOnTarget: function(e, r) {
                for (var t = 0; t < je.eventHandlers.length; ++t)
                    je.eventHandlers[t].target != e || r && r != je.eventHandlers[t].eventTypeString || je._removeHandler(t--)
            },
            ...
            registerOrRemoveHandler: function(e) {
                ...
                if (e.callbackfunc)
                    ...
                    for (var t = 0; t < je.eventHandlers.length; ++t)
                        je.eventHandlers[t].target == e.target && je.eventHandlers[t].eventTypeString == e.eventTypeString && je._removeHandler(t--)
            },
          ...
          , Oe = {};
        var Ge = [0, document, window];
        function ze(e) {
            var r;
            return e = (r = e) > 2 ? L(r) : r,
        ...
        function Ye(e) {
            return Ge.indexOf(e) < 0 ? e.getBoundingClientRect() : {
                left: 0,
                top: 0
            }
        }
        function Ze(e, r) {
            var t = function(e) {
                ...
                function y() {
                    document.fullscreenElement || document.webkitFullscreenElement || document.msFullscreenElement || (document.removeEventListener("fullscreenchange", y),
                    document.removeEventListener("webkitfullscreenchange", y),
                    He(e, t, n),
                    e.style.width = i,
                    e.style.height = a,
                    ...
                    e.style.imageRendering = b,
                    e.GLctxObject && e.GLctxObject.GLctx.viewport(0, 0, t, n),
                    Oe.canvasResizedCallback && mt(Oe.canvasResizedCallback, 37, 0, Oe.canvasResizedCallbackUserData))
                }
            ...
            e.style.width = n + "px",
            e.style.height = i + "px",
            1 == r.filteringMode && (e.style.imageRendering = "optimizeSpeed",
        ...
        function Ke(e, r) {
            if (0 == r.scaleMode && 0 == r.canvasResolutionScaleMode || Ze(e, r),
            e.requestFullscreen)
                e.requestFullscreen();
            else {
                if (!e.webkitRequestFullscreen)
                    return je.fullscreenEnabled() ? -3 : -1;
                e.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT)
            }
            return Oe = r,
            r.canvasResizedCallback && mt(r.canvasResizedCallback, 37, 0, r.canvasResizedCallbackUserData),
            0
        }
        function $e(e) {
        ...
        function Je(e) {
            var r = document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement
              , t = !!r;
            q[e >> 2] = t,
            q[e + 4 >> 2] = je.fullscreenEnabled();
            var n = t ? r : je.previousFullscreenElement
              , i = je.getNodeNameForTarget(n)
              , a = n && n.id ? n.id : "";
            B(i, e + 8, 128),
            B(a, e + 136, 128),
            q[e + 264 >> 2] = n ? n.clientWidth : 0,
            q[e + 268 >> 2] = n ? n.clientHeight : 0,
            q[e + 272 >> 2] = screen.width,
            q[e + 276 >> 2] = screen.height,
            t && (je.previousFullscreenElement = r)
        }
        function er(e, r) {
            X[e >> 3] = r.timestamp;
            for (var t = 0; t < r.axes.length; ++t)
                X[e + 8 * t + 16 >> 3] = r.axes[t];
            for (t = 0; t < r.buttons.length; ++t)
                "object" == typeof r.buttons[t] ? X[e + 8 * t + 528 >> 3] = r.buttons[t].value : X[e + 8 * t + 528 >> 3] = r.buttons[t];
            for (t = 0; t < r.buttons.length; ++t)
                "object" == typeof r.buttons[t] ? q[e + 4 * t + 1040 >> 2] = r.buttons[t].pressed : q[e + 4 * t + 1040 >> 2] = 1 == r.buttons[t];
            q[e + 1296 >> 2] = r.connected,
            q[e + 1300 >> 2] = r.index,
            q[e + 8 >> 2] = r.axes.length,
            q[e + 12 >> 2] = r.buttons.length,
            B(r.id, e + 1304, 64),
            B(r.mapping, e + 1368, 64)
        }
        function rr(e, r) {
        ...
        function ir(e, r, t, n) {
            for (var i = 0; i < e; i++) {
                var a = jr[t]()
                  , o = a && Ue.getNewId(n);
                a ? (a.name = o,
                n[o] = a) : Ue.recordError(1282),
                q[r + 4 * i >> 2] = o
            }
        }
        function ar(e, r) {
            Q[e >> 2] = r,
            Q[e + 4 >> 2] = (r - Q[e >> 2]) / 4294967296
        }
        function or(e, r, t) {
            if (r) {
                var n = void 0;
                ...
                case 36345:
                    ...
                    break;
                case 34466:
                    var i = jr.getParameter(34467);
                    n = i ? i.length : 0;
                    break;
                case 33309:
                    if (Ue.currentContext.version < 2)
                        return void Ue.recordError(1282);
                    n = 2 * (jr.getSupportedExtensions() || []).length;
                    break;
                case 33307:
                case 33308:
                    if (Ue.currentContext.version < 2)
                    ...
                    case "object":
                        if (null === a)
                            ...
                            try {
                                ...
                                return Ue.recordError(1280),
                                void p("GL_INVALID_ENUM in glGet" + t + "v: Unknown object returned from WebGL getParameter(" + e + ")! (error: " + r + ")")
                            }
                        }
                        break;
                    default:
                        return Ue.recordError(1280),
                        void p("GL_INVALID_ENUM in glGet" + t + "v: Native code calling glGet" + t + "v(" + e + ") and it returns " + a + " of type " + typeof a + "!")
                    }
                }
                switch (t) {
                case 1:
        ...
        function ur(e, r, t, n) {
            if (t) {
                var i, a = jr.getIndexedParameter(e, r);
                switch (typeof a) {
                case "boolean":
                    i = a ? 1 : 0;
                    break;
        ...
        function lr(e, r, t, n) {
            if (t) {
                var i = jr.getUniform(Ue.programs[e], Ue.uniforms[r]);
        ...
        function dr(e) {
            return 0 == (e -= 5120) ? j : 1 == e ? O : 2 == e ? G : 4 == e ? q : 6 == e ? V : 5 == e || 28922 == e || 28520 == e || 30779 == e || 30782 == e ? Q : z
        }
        function mr(e) {
        ...
        function gr(e, r) {
            ...
            r += (r.length > 0 ? "\n" : "") + function(e) {
                var r = Ee()
                  ...
                  , i = r.indexOf("\n", Math.max(t, n)) + 1;
                r = r.slice(i),
                8 & e && "undefined" == typeof emscripten_source_map && (_('Source map information is not available, emscripten_log with EM_LOG_C_STACK will be ignored. Build with "--pre-js $EMSCRIPTEN/src/emscripten-source-map.min.js" linker flag to add source map loading to code.'),
                e ^= 8,
                e |= 16);
                var a = null;
                if (128 & e)
                    for (a = vr(arguments); a[1].indexOf("_emscripten_") >= 0; )
                        a = vr(a[0]);
                var o = r.split("\n");
                r = "";
                ...
                for (var l in o) {
                    ...
                    if (8 & e) {
                        ...
                        (b = y && y.source) && (64 & e && (y.source = y.source.substring(y.source.replace(/\\/g, "/").lastIndexOf("/") + 1)),
                        r += "    at " + h + " (" + y.source + ":" + y.line + ":" + y.column + ")\n")
                    }
                    (16 & e || !b) && (64 & e && (m = m.substring(m.replace(/\\/g, "/").lastIndexOf("/") + 1)),
                    r += (b ? "     = " + d : "    at " + h) + " (" + m + ":" + p + ":" + v + ")\n"),
                    128 & e && a[0] && (a[1] == d && a[2].length > 0 && (r = r.replace(/\s+$/, ""),
                    r += " with values: " + a[1] + a[2] + "\n"),
                    a = vr(a[0]))
                }
                return r.replace(/\s+$/, "")
            }(e)),
            1 & e ? 4 & e ? console.error(r) : 2 & e ? console.warn(r) : 512 & e ? console.info(r) : 256 & e ? console.debug(r) : console.log(r) : 6 & e ? p(r) : m(r)
        }
        var _r = 0;
        function hr(e) {
            try {
                return w.grow(e - U.byteLength + 65535 >>> 16),
                H(w.buffer),
                1
            } catch (e) {}
        }
        function br(e, r, t, n, i, a, o) {
            je.focusEvent || (je.focusEvent = Zr(256));
            var u = {
                target: ze(e),
                eventTypeString: a,
                callbackfunc: n,
                handlerFunc: function(e) {
                    var t = e || event
                      , a = je.getNodeNameForTarget(t.target)
                      , o = t.target.id ? t.target.id : ""
                      , u = je.focusEvent;
                    B(a, u + 0, 128),
                    B(o, u + 128, 128),
                    mt(n, i, u, r) && t.preventDefault()
                },
                useCapture: t
            };
            je.registerOrRemoveHandler(u)
        }
        function yr(e, r, t, n, i, a, o) {
            je.fullscreenChangeEvent || (je.fullscreenChangeEvent = Zr(280));
            var u = {
                target: e,
                eventTypeString: a,
                callbackfunc: n,
                handlerFunc: function(e) {
                    var t = e || event
                      , a = je.fullscreenChangeEvent;
                    Je(a),
                    mt(n, i, a, r) && t.preventDefault()
                },
                useCapture: t
            };
            je.registerOrRemoveHandler(u)
        ...
        function wr(e, r, t, n, i, a, o) {
            je.gamepadEvent || (je.gamepadEvent = Zr(1432));
            var u = {
                target: ze(e),
        ...
        function Er(e, r, t, n, i, a, o) {
            je.keyEvent || (je.keyEvent = Zr(164));
            var u = {
                target: ze(e),
                allowsDeferredCalls: !0,
                eventTypeString: a,
                ...
                handlerFunc: function(e) {
                    var t = e || event
                      , a = je.keyEvent;
                    B(t.key ? t.key : "", a + 0, 32),
                    B(t.code ? t.code : "", a + 32, 32),
                    q[a + 64 >> 2] = t.location,
                    q[a + 68 >> 2] = t.ctrlKey,
                    q[a + 72 >> 2] = t.shiftKey,
                    q[a + 76 >> 2] = t.altKey,
                    q[a + 80 >> 2] = t.metaKey,
                    q[a + 84 >> 2] = t.repeat,
                    B(t.locale ? t.locale : "", a + 88, 32),
                    B(t.char ? t.char : "", a + 120, 32),
                    q[a + 152 >> 2] = t.charCode,
                    q[a + 156 >> 2] = t.keyCode,
                    q[a + 160 >> 2] = t.which,
                    mt(n, i, a, r) && t.preventDefault()
                },
        ...
        function xr(e, r, t) {
            ...
            G[e + 32 >> 1] = r.button,
            G[e + 34 >> 1] = r.buttons;
            var n = r.movementX || r.screenX - je.previousScreenX
              , i = r.movementY || r.screenY - je.previousScreenY;
            q[e + 36 >> 2] = n,
            q[e + 40 >> 2] = i;
            var a = Ye(t);
            q[e + 44 >> 2] = r.clientX - a.left,
            q[e + 48 >> 2] = r.clientY - a.top,
            "wheel" !== r.type && "mousewheel" !== r.type && (je.previousScreenX = r.screenX,
            je.previousScreenY = r.screenY)
        }
        function kr(e, r, t, n, i, a, o) {
            je.mouseEvent || (je.mouseEvent = Zr(64));
            var u = {
                target: e = ze(e),
                ...
                handlerFunc: function(t) {
                    var a = t || event;
                    xr(je.mouseEvent, a, e),
                    mt(n, i, je.mouseEvent, r) && a.preventDefault()
                },
                useCapture: t
            };
            je.registerOrRemoveHandler(u)
        ...
        function Cr(e, r, t, n, i, a, o) {
            je.pointerlockChangeEvent || (je.pointerlockChangeEvent = Zr(260));
            var u = {
                target: e,
                eventTypeString: a,
                callbackfunc: n,
                handlerFunc: function(e) {
                    ...
                    !function(e) {
                        var r = document.pointerLockElement || document.mozPointerLockElement || document.webkitPointerLockElement || document.msPointerLockElement
                          , t = !!r;
                        q[e >> 2] = t;
                        var n = je.getNodeNameForTarget(r)
                          , i = r && r.id ? r.id : "";
                        B(n, e + 4, 128),
                        B(i, e + 132, 128)
                    }(a),
        ...
        function Sr(e, r, t, n, i, a, o) {
            je.touchEvent || (je.touchEvent = Zr(1684));
            var u = {
                target: e = ze(e),
                ...
                handlerFunc: function(t) {
                    for (var a = t || event, o = {}, u = 0; u < a.touches.length; ++u) {
                        (s = a.touches[u]).changed = !1,
                        o[s.identifier] = s
                    }
                    for (u = 0; u < a.changedTouches.length; ++u) {
                        o[(s = a.changedTouches[u]).identifier] = s,
                        s.changed = !0
                    }
                    ...
                    for (var u in o) {
                        ...
                        q[l + 28 >> 2] = m.changed,
                        q[l + 32 >> 2] = m.onTarget,
                        q[l + 36 >> 2] = m.clientX - f.left,
                        q[l + 40 >> 2] = m.clientY - f.top,
                        l += 52,
                        ++d >= 32)
                            break
                    }
                    q[c >> 2] = d,
                    mt(n, i, c, r) && a.preventDefault()
                },
                useCapture: t
            };
            je.registerOrRemoveHandler(u)
        ...
        function Dr(e, r, t, n, i, a, o) {
            je.visibilityChangeEvent || (je.visibilityChangeEvent = Zr(8));
            var u = {
                target: e,
                eventTypeString: a,
                callbackfunc: n,
                handlerFunc: function(e) {
                    var t, a, o = e || event, u = je.visibilityChangeEvent;
                    t = u,
                    a = ["hidden", "visible", "prerender", "unloaded"].indexOf(document.visibilityState),
                    q[t >> 2] = document.hidden,
                    q[t + 4 >> 2] = a,
                    mt(n, i, u, r) && o.preventDefault()
                },
                useCapture: t
            };
            je.registerOrRemoveHandler(u)
        ...
        function Fr(e, r, t, n, i, a, o) {
            je.wheelEvent || (je.wheelEvent = Zr(96));
            var u = {
                target: e,
                allowsDeferredCalls: !0,
                eventTypeString: a,
                ...
                handlerFunc: "wheel" == a ? function(t) {
                    ...
                    X[o + 72 >> 3] = a.deltaY,
                    X[o + 80 >> 3] = a.deltaZ,
                    q[o + 88 >> 2] = a.deltaMode,
                    mt(n, i, o, r) && a.preventDefault()
                }
                : function(t) {
                    var a = t || event;
                    xr(je.wheelEvent, a, e),
                    X[je.wheelEvent + 64 >> 3] = a.wheelDeltaX || 0;
                    var o = -(a.wheelDeltaY || a.wheelDelta);
                    X[je.wheelEvent + 72 >> 3] = o,
                    X[je.wheelEvent + 80 >> 3] = 0,
                    q[je.wheelEvent + 88 >> 2] = 0,
                    mt(n, i, je.wheelEvent, r) && a.preventDefault()
                }
                ,
                useCapture: t
            };
        ...
        function Pr(e, r, t, n, i) {
            ...
            if (a) {
                ...
                if (k.withCredentials = f,
                k.open(s, o, !y, w, E),
                y || (k.timeout = l),
                k.url_ = o,
                k.responseType = "arraybuffer",
                v && k.overrideMimeType(x),
                p)
                    for (; ; ) {
                        var C = Q[p >> 2];
                        if (!C)
                ...
                Q[e + 0 >> 2] = A;
                var P = g && _ ? O.slice(g, g + _) : null;
                k.onload = function(n) {
                    var i = k.response ? k.response.byteLength : 0
                      , a = 0
                      , o = 0;
                    h && !b && (a = Zr(o = i),
                    O.set(new Uint8Array(k.response), a)),
                    Q[e + 12 >> 2] = a,
                    Ar.setu64(e + 16, o),
                    Ar.setu64(e + 24, 0),
                    i && Ar.setu64(e + 32, i),
                    z[e + 40 >> 1] = k.readyState,
                    4 === k.readyState && 0 === k.status && (k.status = i > 0 ? 200 : 404),
                    z[e + 42 >> 1] = k.status,
                    k.statusText && B(k.statusText, e + 44, 64),
                    k.status >= 200 && k.status < 300 ? r && r(e, k, n) : t && t(e, k, n)
                }
                ,
                k.onerror = function(r) {
                    var n = k.status;
                    4 === k.readyState && 0 === n && (n = 404),
                    Q[e + 12 >> 2] = 0,
                    Ar.setu64(e + 16, 0),
                    Ar.setu64(e + 24, 0),
                    Ar.setu64(e + 32, 0),
                ...
                k.onprogress = function(r) {
                    var t = h && b && k.response ? k.response.byteLength : 0
                      , i = 0;
                    h && b && (i = Zr(t),
                    O.set(new Uint8Array(k.response), i)),
                    Q[e + 12 >> 2] = i,
                    Ar.setu64(e + 16, t),
                    Ar.setu64(e + 24, r.loaded - t),
                    Ar.setu64(e + 32, r.total),
                    z[e + 40 >> 1] = k.readyState,
                ...
                k.onreadystatechange = function(r) {
                    z[e + 40 >> 1] = k.readyState,
                    k.readyState >= 2 && (z[e + 42 >> 1] = k.status),
                    i && i(e, k, r)
                }
                ;
                try {
        ...
        var Br = (B("GMT", 1055568, 4),
        1055568);
        function Rr() {
            if (!Rr.called) {
                Rr.called = !0,
                q[tt() >> 2] = 60 * (new Date).getTimezoneOffset();
                ...
                var n = u(r)
                  ...
                  , a = M(n)
                  , o = M(i);
                t.getTimezoneOffset() < r.getTimezoneOffset() ? (q[et() >> 2] = a,
                q[et() + 4 >> 2] = o) : (q[et() >> 2] = o,
                q[et() + 4 >> 2] = a)
            }
            function u(e) {
        ...
        function Mr(e, r) {
            ...
            q[r >> 2] = t.getSeconds(),
            q[r + 4 >> 2] = t.getMinutes(),
            q[r + 8 >> 2] = t.getHours(),
            q[r + 12 >> 2] = t.getDate(),
            q[r + 16 >> 2] = t.getMonth(),
            q[r + 20 >> 2] = t.getFullYear() - 1900,
            q[r + 24 >> 2] = t.getDay();
            var n = new Date(t.getFullYear(),0,1)
              , i = (t.getTime() - n.getTime()) / 864e5 | 0;
            q[r + 28 >> 2] = i,
            q[r + 36 >> 2] = -60 * t.getTimezoneOffset();
        ...
        Pe.FSNode = Or,
        Pe.staticInit(),
        r.FS_createFolder = Pe.createFolder,
        r.FS_createPath = Pe.createPath,
        r.FS_createDataFile = Pe.createDataFile,
        r.FS_createPreloadedFile = Pe.createPreloadedFile,
        r.FS_createLazyFile = Pe.createLazyFile,
        r.FS_createLink = Pe.createLink,
        r.FS_createDevice = Pe.createDevice,
        r.FS_unlink = Pe.unlink,
        ...
        ,
        Ue.init();
        for (var qr = 0; qr < 32; qr++)
            tr.push(new Array(qr));
        Ar.staticInit();
        function Qr(e, r, t) {
            var n = t > 0 ? t : R(e) + 1
              , i = new Array(n)
        ...
        var Vr = {
            ...
            __sys_fcntl64: function(e, r, t) {
                ...
                try {
                    ...
                    return void 0 !== Pe && e instanceof Pe.ErrnoError || pe(e),
                    -e.errno
                }
            },
                    ...
                    if (a)
                        if (i <= 0)
                            ...
                            try {
                                ...
                                case 4352:
                                    if (n > 0)
                                        for (var u = (o = Re.currentCtx.audioCtx.createBuffer(1, n, i)).getChannelData(0), s = 0; s < n; ++s)
                                            u[s] = .0078125 * O[t++] - 1;
                                    a.bytesPerSample = 1,
                                    a.channels = 1,
                                    a.length = n;
                                ...
                                case 4355:
                                    if (n > 0) {
                                        u = (o = Re.currentCtx.audioCtx.createBuffer(2, n >> 2, i)).getChannelData(0),
                                        c = o.getChannelData(1);
                                        t >>= 1;
                                        for (s = 0; s < n >> 2; ++s)
                                            u[s] = 30517578125e-15 * G[t++],
                                            c[s] = 30517578125e-15 * G[t++]
                                    }
                                    a.bytesPerSample = 2,
                                    a.channels = 2,
                                    a.length = n >> 2;
                                ...
                                case 65553:
                                    if (n > 0) {
                                        u = (o = Re.currentCtx.audioCtx.createBuffer(2, n >> 3, i)).getChannelData(0),
                                        c = o.getChannelData(1);
                                        t >>= 2;
                                        for (s = 0; s < n >> 3; ++s)
                                            u[s] = V[t++],
            ...
            alDeleteBuffers: function(e, r) {
                if (Re.currentCtx) {
                    ...
                    for (t = 0; t < e; ++t) {
                        var n;
                        0 !== (n = q[r + 4 * t >> 2]) && (Re.deviceRefCounts[Re.buffers[n].deviceId]--,
                        delete Re.buffers[n],
                        Re.freeIds.push(n))
                    }
                }
            ...
            alcCloseDevice: function(e) {
                return !(e in Re.deviceRefCounts) || Re.deviceRefCounts[e] > 0 ? 0 : (delete Re.deviceRefCounts[e],
                Re.freeIds.push(e),
                1)
            },
            alcCreateContext: function(e, t) {
                if (!(e in Re.deviceRefCounts))
                    return Re.alcErr = 40961,
                    0;
                var n = null
                  , i = []
                ...
                try {
                    ...
                    return "NotSupportedError" === e.name ? Re.alcErr = 40964 : Re.alcErr = 40961,
                    0
                }
                !function(e, t) {
                    t || (t = [document, r.canvas]),
                    ["keydown", "mousedown", "touchstart"].forEach((function(r) {
                ...
                void 0 === c.createGain && (c.createGain = c.createGainNode);
                var l = c.createGain();
                ...
                if (Re.deviceRefCounts[e]++,
                Re.contexts[f.id] = f,
                null !== a)
                    for (var d in Re.contexts) {
                        var m = Re.contexts[d];
                        m.deviceId === e && (m.hrtf = a,
                        Re.updateContextGlobal(m))
                    }
                return f.id
            },
            alcDestroyContext: function(e) {
                var r = Re.contexts[e];
                Re.currentCtx !== r ? (Re.contexts[e].interval && clearInterval(Re.contexts[e].interval),
                Re.deviceRefCounts[r.deviceId]--,
                delete Re.contexts[e],
                Re.freeIds.push(e)) : Re.alcErr = 40962
            },
            alcGetIntegerv: function(e, r, t, n) {
                if (0 !== t && n)
                    ...
                    case 4098:
                        if (!(e in Re.deviceRefCounts))
                            return void (Re.alcErr = 40961);
                        if (!Re.currentCtx)
                            return void (Re.alcErr = 40962);
                    ...
                    case 4099:
                        ...
                        if (!Re.currentCtx)
                            return void (Re.alcErr = 40962);
                        for (var i = 0; i < Re.currentCtx.attrs.length; i++)
                            q[n + 4 * i >> 2] = Re.currentCtx.attrs[i];
                        break;
                    case 4103:
                        if (!(e in Re.deviceRefCounts))
                            return void (Re.alcErr = 40961);
            ...
            alcMakeContextCurrent: function(e) {
                return 0 === e ? (Re.currentCtx = null,
                0) : (Re.currentCtx = Re.contexts[e],
                1)
            },
            alcOpenDevice: function(e) {
                if (e && L(e) !== Re.DEVICE_NAME)
                    return 0;
                if ("undefined" != typeof AudioContext || "undefined" != typeof webkitAudioContext) {
                    var r = Re.newId();
                    return Re.deviceRefCounts[r] = 0,
                    r
                }
                return 0
            },
            ...
            clock_gettime: function(e, r) {
                ...
                return q[r >> 2] = t / 1e3 | 0,
                q[r + 4 >> 2] = t % 1e3 * 1e3 * 1e3 | 0,
                0
            },
            dlclose: function(e) {
            ...
            eglBindAPI: function(e) {
                return 12448 == e ? (Ne.setErrorCode(12288),
                1) : (Ne.setErrorCode(12300),
                0)
            },
            ...
            eglCreateContext: function(e, t, n, i) {
                ...
                for (var a = 1; ; ) {
                    ...
                    if (12440 != o) {
                        if (12344 == o)
                            break;
                        return Ne.setErrorCode(12292),
                        0
                    }
                    a = q[i + 4 >> 2],
                    i += 8
                }
                return a < 2 || a > 3 ? (Ne.setErrorCode(12293),
                0) : (Ne.contextAttributes.majorVersion = a - 1,
                Ne.contextAttributes.minorVersion = 0,
                Ne.context = Ue.createContext(r.canvas, Ne.contextAttributes),
                0 != Ne.context ? (Ne.setErrorCode(12288),
                Ue.makeContextCurrent(Ne.context),
                r.useWebGL = !0,
                Be.moduleContextCreatedCallbacks.forEach((function(e) {
                    e()
                }
                )),
                Ue.makeContextCurrent(null),
                62004) : (Ne.setErrorCode(12297),
                0))
            },
            eglCreateWindowSurface: function(e, r, t, n) {
                return 62e3 != e ? (Ne.setErrorCode(12296),
                0) : 62002 != r ? (Ne.setErrorCode(12293),
                0) : (Ne.setErrorCode(12288),
                62006)
            },
            eglDestroyContext: function(e, r) {
                return 62e3 != e ? (Ne.setErrorCode(12296),
                0) : 62004 != r ? (Ne.setErrorCode(12294),
                0) : (Ue.deleteContext(Ne.context),
                Ne.setErrorCode(12288),
            ...
            eglDestroySurface: function(e, r) {
                return 62e3 != e ? (Ne.setErrorCode(12296),
                0) : 62006 != r ? (Ne.setErrorCode(12301),
                1) : (Ne.currentReadSurface == r && (Ne.currentReadSurface = 0),
            ...
            eglGetConfigAttrib: function(e, r, t, n) {
                if (62e3 != e)
                    ...
                    0;
                if (62002 != r)
                    return Ne.setErrorCode(12293),
                    0;
                if (!n)
                    return Ne.setErrorCode(12300),
                    0;
                switch (Ne.setErrorCode(12288),
                t) {
                case 12320:
                    return q[n >> 2] = Ne.contextAttributes.alpha ? 32 : 24,
                    1;
                case 12321:
                    return q[n >> 2] = Ne.contextAttributes.alpha ? 8 : 0,
                    1;
                case 12322:
                case 12323:
                case 12324:
                    ...
                    1;
                case 12325:
                    return q[n >> 2] = Ne.contextAttributes.depth ? 24 : 0,
                    1;
                case 12326:
                    return q[n >> 2] = Ne.contextAttributes.stencil ? 8 : 0,
                    1;
                case 12327:
                    return q[n >> 2] = 12344,
                    1;
                ...
                case 12335:
                    ...
                    1;
                case 12337:
                    return q[n >> 2] = Ne.contextAttributes.antialias ? 4 : 0,
                    1;
                case 12338:
                    return q[n >> 2] = Ne.contextAttributes.antialias ? 1 : 0,
                    1;
                case 12339:
                    return q[n >> 2] = 4,
                    1;
            ...
            eglInitialize: function(e, r, t) {
                return 62e3 == e ? (r && (q[r >> 2] = 1),
                t && (q[t >> 2] = 4),
                Ne.defaultDisplayInitialized = !0,
                Ne.setErrorCode(12288),
                1) : (Ne.setErrorCode(12296),
                0)
            },
            eglMakeCurrent: function(e, r, t, n) {
                return 62e3 != e ? (Ne.setErrorCode(12296),
                0) : 0 != n && 62004 != n ? (Ne.setErrorCode(12294),
                0) : 0 != t && 62006 != t || 0 != r && 62006 != r ? (Ne.setErrorCode(12301),
                0) : (Ue.makeContextCurrent(n ? Ne.context : null),
                Ne.currentContext = n,
            ...
            eglQueryString: function(e, r) {
                ...
                return Ne.stringCache[r] = t,
                t
            },
            eglSwapBuffers: function() {
                if (Ne.defaultDisplayInitialized)
                    if (r.ctx) {
                        if (!r.ctx.isContextLost())
                            return Ne.setErrorCode(12288),
                            1;
                        Ne.setErrorCode(12302)
                    } else
                        Ne.setErrorCode(12290);
                else
                    Ne.setErrorCode(12289);
                return 0
            },
            ...
            emscripten_exit_fullscreen: function() {
                if (!je.fullscreenEnabled())
                    return -1;
                je.removeDeferredCalls(Ke);
                var e = Ge[1];
                if (e.exitFullscreen)
            ...
            emscripten_get_element_css_size: function(e, r, t) {
                if (!(e = ze(e)))
                    return -4;
                var n = Ye(e);
                return X[r >> 3] = n.width,
                X[t >> 3] = n.height,
                0
            },
            emscripten_get_fullscreen_status: function(e) {
                return je.fullscreenEnabled() ? (Je(e),
                0) : -1
            },
            emscripten_get_gamepad_status: function(e, r) {
                return e < 0 || e >= je.lastGamepadState.length ? -5 : je.lastGamepadState[e] ? (er(r, je.lastGamepadState[e]),
                0) : -7
            },
            emscripten_get_now: ke,
            emscripten_get_num_gamepads: function() {
                return je.lastGamepadState.length
            },
            ...
            emscripten_glClientWaitSync: function(e, r, t, n) {
                return jr.clientWaitSync(Ue.syncs[e], r, rr(t, n))
            },
            emscripten_glColorMask: function(e, r, t, n) {
                jr.colorMask(!!e, !!r, !!t, !!n)
            },
            emscripten_glCompileShader: function(e) {
                jr.compileShader(Ue.shaders[e])
            },
            emscripten_glCompressedTexImage2D: function(e, r, t, n, i, a, o, u) {
                Ue.currentContext.version >= 2 ? jr.currentPixelUnpackBufferBinding ? jr.compressedTexImage2D(e, r, t, n, i, a, o, u) : jr.compressedTexImage2D(e, r, t, n, i, a, O, u, o) : jr.compressedTexImage2D(e, r, t, n, i, a, u ? O.subarray(u, u + o) : null)
            },
            emscripten_glCompressedTexImage3D: function(e, r, t, n, i, a, o, u, s) {
                jr.currentPixelUnpackBufferBinding ? jr.compressedTexImage3D(e, r, t, n, i, a, o, u, s) : jr.compressedTexImage3D(e, r, t, n, i, a, o, O, s, u)
            },
            emscripten_glCompressedTexSubImage2D: function(e, r, t, n, i, a, o, u, s) {
                Ue.currentContext.version >= 2 ? jr.currentPixelUnpackBufferBinding ? jr.compressedTexSubImage2D(e, r, t, n, i, a, o, u, s) : jr.compressedTexSubImage2D(e, r, t, n, i, a, o, O, s, u) : jr.compressedTexSubImage2D(e, r, t, n, i, a, o, s ? O.subarray(s, s + u) : null)
            },
            emscripten_glCompressedTexSubImage3D: function(e, r, t, n, i, a, o, u, s, c, l) {
                jr.currentPixelUnpackBufferBinding ? jr.compressedTexSubImage3D(e, r, t, n, i, a, o, u, s, c, l) : jr.compressedTexSubImage3D(e, r, t, n, i, a, o, u, s, O, l, c)
            },
            emscripten_glCopyBufferSubData: function(e, r, t, n, i) {
                jr.copyBufferSubData(e, r, t, n, i)
            },
            emscripten_glCopyTexImage2D: function(e, r, t, n, i, a, o, u) {
                jr.copyTexImage2D(e, r, t, n, i, a, o, u)
            },
            emscripten_glCopyTexSubImage2D: function(e, r, t, n, i, a, o, u) {
                jr.copyTexSubImage2D(e, r, t, n, i, a, o, u)
            },
            emscripten_glCopyTexSubImage3D: function(e, r, t, n, i, a, o, u, s) {
                jr.copyTexSubImage3D(e, r, t, n, i, a, o, u, s)
            },
            ...
            emscripten_glCreateShader: function(e) {
                ...
                return Ue.shaders[r] = jr.createShader(e),
                r
            },
            ...
            emscripten_glDeleteBuffers: function(e, r) {
                for (var t = 0; t < e; t++) {
                    ...
                    i.name = 0,
                    Ue.buffers[n] = null,
                    n == Ue.currArrayBuffer && (Ue.currArrayBuffer = 0),
                    n == Ue.currElementArrayBuffer && (Ue.currElementArrayBuffer = 0),
                    n == jr.currentPixelPackBufferBinding && (jr.currentPixelPackBufferBinding = 0),
                    n == jr.currentPixelUnpackBufferBinding && (jr.currentPixelUnpackBufferBinding = 0))
                }
            },
            emscripten_glDeleteFramebuffers: function(e, r) {
                for (var t = 0; t < e; ++t) {
                    var n = q[r + 4 * t >> 2]
                      , i = Ue.framebuffers[n];
                    i && (jr.deleteFramebuffer(i),
                    i.name = 0,
                    Ue.framebuffers[n] = null)
                }
            },
            emscripten_glDeleteProgram: function(e) {
                if (e) {
                    var r = Ue.programs[e];
                    r ? (jr.deleteProgram(r),
                    r.name = 0,
                    Ue.programs[e] = null,
                    Ue.programInfos[e] = null) : Ue.recordError(1281)
                }
            },
            ...
            emscripten_glDeleteQueriesEXT: function(e, r) {
                for (var t = 0; t < e; t++) {
                    ...
                    i && (jr.disjointTimerQueryExt.deleteQueryEXT(i),
                    Ue.timerQueriesEXT[n] = null)
                }
            },
            emscripten_glDeleteRenderbuffers: function(e, r) {
                for (var t = 0; t < e; t++) {
                    ...
                    i && (jr.deleteRenderbuffer(i),
                    i.name = 0,
                    Ue.renderbuffers[n] = null)
                }
            },
            ...
            emscripten_glDeleteShader: function(e) {
                if (e) {
                    var r = Ue.shaders[e];
                    r ? (jr.deleteShader(r),
                    Ue.shaders[e] = null) : Ue.recordError(1281)
                }
            },
            emscripten_glDeleteSync: function(e) {
                if (e) {
                    ...
                    r ? (jr.deleteSync(r),
                    r.name = 0,
                    Ue.syncs[e] = null) : Ue.recordError(1281)
                }
            },
            ...
            emscripten_glDeleteTransformFeedbacks: function(e, r) {
                for (var t = 0; t < e; t++) {
                    ...
                    i && (jr.deleteTransformFeedback(i),
                    i.name = 0,
                    Ue.transformFeedbacks[n] = null)
                }
            },
            emscripten_glDeleteVertexArrays: function(e, r) {
                for (var t = 0; t < e; t++) {
                    var n = q[r + 4 * t >> 2];
                    jr.deleteVertexArray(Ue.vaos[n]),
                    Ue.vaos[n] = null
                }
            },
            ...
            emscripten_glDrawElementsInstanced: function(e, r, t, n, i) {
                jr.drawElementsInstanced(e, r, t, n, i)
            },
            ...
            emscripten_glFramebufferRenderbuffer: function(e, r, t, n) {
                jr.framebufferRenderbuffer(e, r, t, Ue.renderbuffers[n])
            },
            emscripten_glFramebufferTexture2D: function(e, r, t, n, i) {
                jr.framebufferTexture2D(e, r, t, Ue.textures[n], i)
            },
            emscripten_glFramebufferTextureLayer: function(e, r, t, n, i) {
                jr.framebufferTextureLayer(e, r, Ue.textures[t], n, i)
            },
            ...
            emscripten_glGenQueriesEXT: function(e, r) {
                for (var t = 0; t < e; t++) {
                    var n = jr.disjointTimerQueryExt.createQueryEXT();
                    if (!n) {
                        for (Ue.recordError(1282); t < e; )
                            q[r + 4 * t++ >> 2] = 0;
                        return
                    }
                    var i = Ue.getNewId(Ue.timerQueriesEXT);
                    n.name = i,
                    Ue.timerQueriesEXT[i] = n,
                    q[r + 4 * t >> 2] = i
                }
            },
            ...
            emscripten_glGetActiveUniformBlockName: function(e, r, t, n, i) {
                e = Ue.programs[e];
                var a = jr.getActiveUniformBlockName(e, r);
                if (a)
                    if (i && t > 0) {
                        var o = B(a, i, t);
                        n && (q[n >> 2] = o)
            ...
            emscripten_glGetActiveUniformBlockiv: function(e, r, t, n) {
                if (n)
                    switch (e = Ue.programs[e],
                    t) {
                    case 35393:
                        var i = jr.getActiveUniformBlockName(e, r);
                        return void (q[n >> 2] = i.length + 1);
                    default:
                        var a = jr.getActiveUniformBlockParameter(e, r, t);
                        if (!a)
                            return;
                        if ("number" == typeof a)
                            q[n >> 2] = a;
            ...
            emscripten_glGetActiveUniformsiv: function(e, r, t, n, i) {
                if (i)
                    if (r > 0 && 0 == t)
                        ...
                        for (var a = [], o = 0; o < r; o++)
                            a.push(q[t + 4 * o >> 2]);
                        var u = jr.getActiveUniforms(e, a, n);
                        if (u) {
                            var s = u.length;
                            for (o = 0; o < s; o++)
                                q[i + 4 * o >> 2] = u[o]
            ...
            emscripten_glGetAttachedShaders: function(e, r, t, n) {
                var i = jr.getAttachedShaders(Ue.programs[e])
                  , a = i.length;
                a > r && (a = r),
                q[t >> 2] = a;
                for (var o = 0; o < a; ++o) {
            ...
            emscripten_glGetAttribLocation: function(e, r) {
                return jr.getAttribLocation(Ue.programs[e], L(r))
            },
            emscripten_glGetBooleanv: function(e, r) {
                or(e, r, 4)
            },
            emscripten_glGetBufferParameteri64v: function(e, r, t) {
                t ? ar(t, jr.getBufferParameter(e, r)) : Ue.recordError(1281)
            },
            emscripten_glGetBufferParameteriv: function(e, r, t) {
                t ? q[t >> 2] = jr.getBufferParameter(e, r) : Ue.recordError(1281)
            },
            emscripten_glGetError: function() {
                var e = jr.getError() || Ue.lastError;
                return Ue.lastError = 0,
                e
            },
            ...
            emscripten_glGetFragDataLocation: function(e, r) {
                return jr.getFragDataLocation(Ue.programs[e], L(r))
            },
            emscripten_glGetFramebufferAttachmentParameteriv: function(e, r, t, n) {
                var i = jr.getFramebufferAttachmentParameter(e, r, t);
                (i instanceof WebGLRenderbuffer || i instanceof WebGLTexture) && (i = 0 | i.name),
                q[n >> 2] = i
            },
            ...
            emscripten_glGetInternalformativ: function(e, r, t, n, i) {
                if (n < 0)
                    ...
                    var a = jr.getInternalformatParameter(e, r, t);
                    if (null !== a)
                        for (var o = 0; o < a.length && o < n; ++o)
                            q[i + o >> 2] = a[o]
                } else
                    Ue.recordError(1281)
            },
            ...
            emscripten_glGetProgramInfoLog: function(e, r, t, n) {
                var i = jr.getProgramInfoLog(Ue.programs[e]);
                    ...
                    if (e >= Ue.counter)
                        ...
                        if (n)
                            if (35716 == r) {
                                ...
                                q[t >> 2] = n.maxUniformLength;
                            else if (35722 == r) {
                                if (-1 == n.maxAttributeLength) {
                                    e = Ue.programs[e];
                                    var a = jr.getProgramParameter(e, 35721);
                                    n.maxAttributeLength = 0;
                                    for (var o = 0; o < a; ++o) {
                                        var u = jr.getActiveAttrib(e, o);
            ...
            emscripten_glGetQueryObjecti64vEXT: function(e, r, t) {
                if (t) {
                    var n = Ue.timerQueriesEXT[e]
                      , i = jr.disjointTimerQueryExt.getQueryObjectEXT(n, r);
            ...
            emscripten_glGetQueryObjectivEXT: function(e, r, t) {
                if (t) {
                    var n, i = Ue.timerQueriesEXT[e], a = jr.disjointTimerQueryExt.getQueryObjectEXT(i, r);
            ...
            emscripten_glGetQueryObjectuiv: function(e, r, t) {
                if (t) {
                    var n, i = Ue.queries[e], a = jr.getQueryParameter(i, r);
                    n = "boolean" == typeof a ? a ? 1 : 0 : a,
                    q[t >> 2] = n
                } else
                    Ue.recordError(1281)
            ...
            emscripten_glGetQueryiv: function(e, r, t) {
                t ? q[t >> 2] = jr.getQuery(e, r) : Ue.recordError(1281)
            },
            emscripten_glGetQueryivEXT: function(e, r, t) {
                t ? q[t >> 2] = jr.disjointTimerQueryExt.getQueryEXT(e, r) : Ue.recordError(1281)
            },
            emscripten_glGetRenderbufferParameteriv: function(e, r, t) {
                t ? q[t >> 2] = jr.getRenderbufferParameter(e, r) : Ue.recordError(1281)
            },
            emscripten_glGetSamplerParameterfv: function(e, r, t) {
                t ? (e = Ue.samplers[e],
                V[t >> 2] = jr.getSamplerParameter(e, r)) : Ue.recordError(1281)
            },
            emscripten_glGetSamplerParameteriv: function(e, r, t) {
                t ? (e = Ue.samplers[e],
                q[t >> 2] = jr.getSamplerParameter(e, r)) : Ue.recordError(1281)
            },
            emscripten_glGetShaderInfoLog: function(e, r, t, n) {
                var i = jr.getShaderInfoLog(Ue.shaders[e]);
                null === i && (i = "(unknown error)");
                var a = r > 0 && n ? B(i, n, r) : 0;
                t && (q[t >> 2] = a)
            },
            emscripten_glGetShaderPrecisionFormat: function(e, r, t, n) {
                var i = jr.getShaderPrecisionFormat(e, r);
                q[t >> 2] = i.rangeMin,
                q[t + 4 >> 2] = i.rangeMax,
                q[n >> 2] = i.precision
            },
            emscripten_glGetShaderSource: function(e, r, t, n) {
                var i = jr.getShaderSource(Ue.shaders[e]);
                if (i) {
                    var a = r > 0 && n ? B(i, n, r) : 0;
                    t && (q[t >> 2] = a)
                }
            ...
            emscripten_glGetShaderiv: function(e, r, t) {
                if (t)
                    if (35716 == r) {
                        var n = jr.getShaderInfoLog(Ue.shaders[e]);
                        ...
                        q[t >> 2] = jr.getShaderParameter(Ue.shaders[e], r);
                else
                    Ue.recordError(1281)
            },
            emscripten_glGetString: function(e) {
                if (Ue.stringCache[e])
                    return Ue.stringCache[e];
                var r;
                switch (e) {
                case 7939:
                    var t = jr.getSupportedExtensions() || [];
                ...
                case 37445:
                case 37446:
                    var n = jr.getParameter(e);
                    n || Ue.recordError(1280),
                    r = sr(n);
                    break;
                case 7938:
                    var i = jr.getParameter(7938);
                    r = sr(i = Ue.currentContext.version >= 2 ? "OpenGL ES 3.0 (" + i + ")" : "OpenGL ES 2.0 (" + i + ")");
                    break;
                case 35724:
                    var a = jr.getParameter(35724)
                ...
                return Ue.stringCache[e] = r,
                r
            },
            emscripten_glGetStringi: function(e, r) {
                if (Ue.currentContext.version < 2)
                    return Ue.recordError(1282),
                    0;
                var t = Ue.stringiCache[e];
                if (t)
                    return r < 0 || r >= t.length ? (Ue.recordError(1281),
                    0) : t[r];
                switch (e) {
                case 7939:
                    var n = jr.getSupportedExtensions() || [];
                    ...
                    t = Ue.stringiCache[e] = n,
                    r < 0 || r >= t.length ? (Ue.recordError(1281),
                    0) : t[r];
                default:
                    return Ue.recordError(1280),
                    0
            ...
            emscripten_glGetSynciv: function(e, r, t, n, i) {
                if (t < 0)
                    ...
                    var a = jr.getSyncParameter(Ue.syncs[e], r);
                    q[n >> 2] = a,
                    null !== a && n && (q[n >> 2] = 1)
                } else
                    Ue.recordError(1281)
            ...
            emscripten_glGetTexParameterfv: function(e, r, t) {
                t ? V[t >> 2] = jr.getTexParameter(e, r) : Ue.recordError(1281)
            },
            emscripten_glGetTexParameteriv: function(e, r, t) {
                t ? q[t >> 2] = jr.getTexParameter(e, r) : Ue.recordError(1281)
            },
            emscripten_glGetTransformFeedbackVarying: function(e, r, t, n, i, a, o) {
                e = Ue.programs[e];
                var u = jr.getTransformFeedbackVarying(e, r);
                if (u) {
                    if (o && t > 0) {
                        var s = B(u.name, o, t);
                        n && (q[n >> 2] = s)
            ...
            emscripten_glGetUniformBlockIndex: function(e, r) {
                return jr.getUniformBlockIndex(Ue.programs[e], L(r))
            },
            emscripten_glGetUniformIndices: function(e, r, t, n) {
                if (n)
                    if (r > 0 && (0 == t || 0 == n))
                        ...
                        for (var i = [], a = 0; a < r; a++)
                            i.push(L(q[t + 4 * a >> 2]));
                        var o = jr.getUniformIndices(e, i);
                        if (o) {
                            var u = o.length;
                            for (a = 0; a < u; a++)
                                q[n + 4 * a >> 2] = o[a]
            ...
            emscripten_glGetVertexAttribPointerv: function(e, r, t) {
                t ? q[t >> 2] = jr.getVertexAttribOffset(e, r) : Ue.recordError(1281)
            },
            ...
            emscripten_glLinkProgram: function(e) {
                jr.linkProgram(Ue.programs[e]),
                Ue.populateUniformTable(e)
            },
            emscripten_glPauseTransformFeedback: function() {
                jr.pauseTransformFeedback()
            },
            emscripten_glPixelStorei: function(e, r) {
                3317 == e && (Ue.unpackAlignment = r),
                jr.pixelStorei(e, r)
            },
            emscripten_glPolygonOffset: function(e, r) {
                jr.polygonOffset(e, r)
            },
            ...
            emscripten_glQueryCounterEXT: function(e, r) {
                jr.disjointTimerQueryExt.queryCounterEXT(Ue.timerQueriesEXT[e], r)
            },
            ...
            emscripten_glShaderSource: function(e, r, t, n) {
                ...
                jr.shaderSource(Ue.shaders[e], i)
            },
            emscripten_glStencilFunc: function(e, r, t) {
                jr.stencilFunc(e, r, t)
            },
            emscripten_glStencilFuncSeparate: function(e, r, t, n) {
                jr.stencilFuncSeparate(e, r, t, n)
            },
            emscripten_glStencilMask: function(e) {
                jr.stencilMask(e)
            },
            emscripten_glStencilMaskSeparate: function(e, r) {
                jr.stencilMaskSeparate(e, r)
            },
            emscripten_glStencilOp: function(e, r, t) {
                jr.stencilOp(e, r, t)
            },
            emscripten_glStencilOpSeparate: function(e, r, t, n) {
                jr.stencilOpSeparate(e, r, t, n)
            },
            emscripten_glTexImage2D: function(e, r, t, n, i, a, o, u, s) {
                if (Ue.currentContext.version >= 2)
                    if (jr.currentPixelUnpackBufferBinding)
                        jr.texImage2D(e, r, t, n, i, a, o, u, s);
                    else if (s) {
                        var c = dr(u);
                        jr.texImage2D(e, r, t, n, i, a, o, u, c, s >> mr(c))
                    } else
                        jr.texImage2D(e, r, t, n, i, a, o, u, null);
                else
                    jr.texImage2D(e, r, t, n, i, a, o, u, s ? pr(u, o, n, i, s) : null)
            },
            emscripten_glTexImage3D: function(e, r, t, n, i, a, o, u, s, c) {
                if (jr.currentPixelUnpackBufferBinding)
                    jr.texImage3D(e, r, t, n, i, a, o, u, s, c);
                else if (c) {
                    var l = dr(s);
                    jr.texImage3D(e, r, t, n, i, a, o, u, s, l, c >> mr(l))
                } else
                    jr.texImage3D(e, r, t, n, i, a, o, u, s, null)
            },
            emscripten_glTexParameterf: function(e, r, t) {
                jr.texParameterf(e, r, t)
            },
            emscripten_glTexParameterfv: function(e, r, t) {
                var n = V[t >> 2];
                jr.texParameterf(e, r, n)
            },
            emscripten_glTexParameteri: function(e, r, t) {
                jr.texParameteri(e, r, t)
            },
            emscripten_glTexParameteriv: function(e, r, t) {
                var n = q[t >> 2];
                jr.texParameteri(e, r, n)
            },
            emscripten_glTexStorage2D: function(e, r, t, n, i) {
                jr.texStorage2D(e, r, t, n, i)
            },
            emscripten_glTexStorage3D: function(e, r, t, n, i, a) {
                jr.texStorage3D(e, r, t, n, i, a)
            },
            emscripten_glTexSubImage2D: function(e, r, t, n, i, a, o, u, s) {
                if (Ue.currentContext.version >= 2)
                    if (jr.currentPixelUnpackBufferBinding)
                        jr.texSubImage2D(e, r, t, n, i, a, o, u, s);
                    else if (s) {
                        var c = dr(u);
                        jr.texSubImage2D(e, r, t, n, i, a, o, u, c, s >> mr(c))
                    } else
                        jr.texSubImage2D(e, r, t, n, i, a, o, u, null);
                else {
                    var l = null;
                    s && (l = pr(u, o, i, a, s)),
                    jr.texSubImage2D(e, r, t, n, i, a, o, u, l)
                }
            },
            emscripten_glTexSubImage3D: function(e, r, t, n, i, a, o, u, s, c, l) {
                if (jr.currentPixelUnpackBufferBinding)
                    jr.texSubImage3D(e, r, t, n, i, a, o, u, s, c, l);
                else if (l) {
                    var f = dr(c);
                    jr.texSubImage3D(e, r, t, n, i, a, o, u, s, c, f, l >> mr(f))
                } else
                    jr.texSubImage3D(e, r, t, n, i, a, o, u, s, c, null)
            },
            emscripten_glTransformFeedbackVaryings: function(e, r, t, n) {
                e = Ue.programs[e];
                for (var i = [], a = 0; a < r; a++)
                    i.push(L(q[t + 4 * a >> 2]));
                jr.transformFeedbackVaryings(e, i, n)
            },
            emscripten_glUniform1f: function(e, r) {
                jr.uniform1f(Ue.uniforms[e], r)
            },
            emscripten_glUniform1fv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform1fv(Ue.uniforms[e], V, t >> 2, r);
                else {
                    if (r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferFloatViews[r - 1], i = 0; i < r; ++i)
                            n[i] = V[t + 4 * i >> 2];
                    else
                        n = V.subarray(t >> 2, t + 4 * r >> 2);
                    jr.uniform1fv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform1i: function(e, r) {
                jr.uniform1i(Ue.uniforms[e], r)
            },
            emscripten_glUniform1iv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform1iv(Ue.uniforms[e], q, t >> 2, r);
                else {
                    if (r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferIntViews[r - 1], i = 0; i < r; ++i)
                            n[i] = q[t + 4 * i >> 2];
                    else
                        n = q.subarray(t >> 2, t + 4 * r >> 2);
                    jr.uniform1iv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform1ui: function(e, r) {
                jr.uniform1ui(Ue.uniforms[e], r)
            },
            emscripten_glUniform1uiv: function(e, r, t) {
                jr.uniform1uiv(Ue.uniforms[e], Q, t >> 2, r)
            },
            emscripten_glUniform2f: function(e, r, t) {
                jr.uniform2f(Ue.uniforms[e], r, t)
            },
            emscripten_glUniform2fv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform2fv(Ue.uniforms[e], V, t >> 2, 2 * r);
                else {
                    if (2 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferFloatViews[2 * r - 1], i = 0; i < 2 * r; i += 2)
                            n[i] = V[t + 4 * i >> 2],
                            n[i + 1] = V[t + (4 * i + 4) >> 2];
                    else
                        n = V.subarray(t >> 2, t + 8 * r >> 2);
                    jr.uniform2fv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform2i: function(e, r, t) {
                jr.uniform2i(Ue.uniforms[e], r, t)
            },
            emscripten_glUniform2iv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform2iv(Ue.uniforms[e], q, t >> 2, 2 * r);
                else {
                    if (2 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferIntViews[2 * r - 1], i = 0; i < 2 * r; i += 2)
                            n[i] = q[t + 4 * i >> 2],
                            n[i + 1] = q[t + (4 * i + 4) >> 2];
                    else
                        n = q.subarray(t >> 2, t + 8 * r >> 2);
                    jr.uniform2iv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform2ui: function(e, r, t) {
                jr.uniform2ui(Ue.uniforms[e], r, t)
            },
            emscripten_glUniform2uiv: function(e, r, t) {
                jr.uniform2uiv(Ue.uniforms[e], Q, t >> 2, 2 * r)
            },
            emscripten_glUniform3f: function(e, r, t, n) {
                jr.uniform3f(Ue.uniforms[e], r, t, n)
            },
            emscripten_glUniform3fv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform3fv(Ue.uniforms[e], V, t >> 2, 3 * r);
                else {
                    if (3 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferFloatViews[3 * r - 1], i = 0; i < 3 * r; i += 3)
                            n[i] = V[t + 4 * i >> 2],
                            n[i + 1] = V[t + (4 * i + 4) >> 2],
                            n[i + 2] = V[t + (4 * i + 8) >> 2];
                    else
                        n = V.subarray(t >> 2, t + 12 * r >> 2);
                    jr.uniform3fv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform3i: function(e, r, t, n) {
                jr.uniform3i(Ue.uniforms[e], r, t, n)
            },
            emscripten_glUniform3iv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform3iv(Ue.uniforms[e], q, t >> 2, 3 * r);
                else {
                    if (3 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferIntViews[3 * r - 1], i = 0; i < 3 * r; i += 3)
                            n[i] = q[t + 4 * i >> 2],
                            n[i + 1] = q[t + (4 * i + 4) >> 2],
                            n[i + 2] = q[t + (4 * i + 8) >> 2];
                    else
                        n = q.subarray(t >> 2, t + 12 * r >> 2);
                    jr.uniform3iv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform3ui: function(e, r, t, n) {
                jr.uniform3ui(Ue.uniforms[e], r, t, n)
            },
            emscripten_glUniform3uiv: function(e, r, t) {
                jr.uniform3uiv(Ue.uniforms[e], Q, t >> 2, 3 * r)
            },
            emscripten_glUniform4f: function(e, r, t, n, i) {
                jr.uniform4f(Ue.uniforms[e], r, t, n, i)
            },
            emscripten_glUniform4fv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform4fv(Ue.uniforms[e], V, t >> 2, 4 * r);
                else {
                    if (4 * r <= Ue.MINI_TEMP_BUFFER_SIZE) {
                        ...
                        n = V.subarray(t >> 2, t + 16 * r >> 2);
                    jr.uniform4fv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform4i: function(e, r, t, n, i) {
                jr.uniform4i(Ue.uniforms[e], r, t, n, i)
            },
            emscripten_glUniform4iv: function(e, r, t) {
                if (Ue.currentContext.version >= 2)
                    jr.uniform4iv(Ue.uniforms[e], q, t >> 2, 4 * r);
                else {
                    if (4 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var n = Ue.miniTempBufferIntViews[4 * r - 1], i = 0; i < 4 * r; i += 4)
                            n[i] = q[t + 4 * i >> 2],
                            n[i + 1] = q[t + (4 * i + 4) >> 2],
                            n[i + 2] = q[t + (4 * i + 8) >> 2],
                            n[i + 3] = q[t + (4 * i + 12) >> 2];
                    else
                        n = q.subarray(t >> 2, t + 16 * r >> 2);
                    jr.uniform4iv(Ue.uniforms[e], n)
                }
            },
            emscripten_glUniform4ui: function(e, r, t, n, i) {
                jr.uniform4ui(Ue.uniforms[e], r, t, n, i)
            },
            emscripten_glUniform4uiv: function(e, r, t) {
                jr.uniform4uiv(Ue.uniforms[e], Q, t >> 2, 4 * r)
            },
            emscripten_glUniformBlockBinding: function(e, r, t) {
                e = Ue.programs[e],
                jr.uniformBlockBinding(e, r, t)
            },
            emscripten_glUniformMatrix2fv: function(e, r, t, n) {
                if (Ue.currentContext.version >= 2)
                    jr.uniformMatrix2fv(Ue.uniforms[e], !!t, V, n >> 2, 4 * r);
                else {
                    if (4 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var i = Ue.miniTempBufferFloatViews[4 * r - 1], a = 0; a < 4 * r; a += 4)
                            i[a] = V[n + 4 * a >> 2],
                            i[a + 1] = V[n + (4 * a + 4) >> 2],
                            i[a + 2] = V[n + (4 * a + 8) >> 2],
                            i[a + 3] = V[n + (4 * a + 12) >> 2];
                    else
                        i = V.subarray(n >> 2, n + 16 * r >> 2);
                    jr.uniformMatrix2fv(Ue.uniforms[e], !!t, i)
                }
            },
            emscripten_glUniformMatrix2x3fv: function(e, r, t, n) {
                jr.uniformMatrix2x3fv(Ue.uniforms[e], !!t, V, n >> 2, 6 * r)
            },
            emscripten_glUniformMatrix2x4fv: function(e, r, t, n) {
                jr.uniformMatrix2x4fv(Ue.uniforms[e], !!t, V, n >> 2, 8 * r)
            },
            emscripten_glUniformMatrix3fv: function(e, r, t, n) {
                if (Ue.currentContext.version >= 2)
                    jr.uniformMatrix3fv(Ue.uniforms[e], !!t, V, n >> 2, 9 * r);
                else {
                    if (9 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                        for (var i = Ue.miniTempBufferFloatViews[9 * r - 1], a = 0; a < 9 * r; a += 9)
                            i[a] = V[n + 4 * a >> 2],
                            i[a + 1] = V[n + (4 * a + 4) >> 2],
                            i[a + 2] = V[n + (4 * a + 8) >> 2],
                            i[a + 3] = V[n + (4 * a + 12) >> 2],
                        ...
                        i = V.subarray(n >> 2, n + 36 * r >> 2);
                    jr.uniformMatrix3fv(Ue.uniforms[e], !!t, i)
                }
            },
            emscripten_glUniformMatrix3x2fv: function(e, r, t, n) {
                jr.uniformMatrix3x2fv(Ue.uniforms[e], !!t, V, n >> 2, 6 * r)
            },
            emscripten_glUniformMatrix3x4fv: function(e, r, t, n) {
                jr.uniformMatrix3x4fv(Ue.uniforms[e], !!t, V, n >> 2, 12 * r)
            },
            emscripten_glUniformMatrix4fv: function(e, r, t, n) {
                if (Ue.currentContext.version >= 2)
                    jr.uniformMatrix4fv(Ue.uniforms[e], !!t, V, n >> 2, 16 * r);
                else {
                    ...
                    for (var a, o, u, s, c = []; ; ) {
                        ...
                        37 == a) {
                            ...
                            case "p":
                                var w = 100 == o || 105 == o;
                                u = i("i" + 8 * (_ = _ || 4)),
                                8 == _ && (u = 117 == o ? (u[0] >>> 0) + 4294967296 * (u[1] >>> 0) : rr(u[0], u[1])),
                                _ <= 4 && (u = (w ? ie : ne)(u & Math.pow(256, _) - 1, 8 * _));
                                var E = Math.abs(u)
                                  , x = "";
                                if (100 == o || 105 == o)
                                    S = ie(u, 8 * _).toString(10);
                                else if (117 == o)
                                    S = ne(u, 8 * _).toString(10),
                                    u = Math.abs(u);
                                else if (111 == o)
                                    S = (m ? "0" : "") + E.toString(8);
                                else if (120 == o || 88 == o) {
                                    ...
                                    u < 0) {
                                        u = -u,
                                        S = (E - 1).toString(16);
                                        for (var k = [], C = 0; C < S.length; C++)
                                            k.push((15 - parseInt(S[C], 16)).toString(16));
                                        for (S = k.join(""); S.length < 2 * _; )
                                            S = "f" + S
                                    } else
                                        S = E.toString(16);
                                    88 == o && (x = x.toUpperCase(),
                                    S = S.toUpperCase())
                                } else
                                    112 == o && (0 === E ? S = "(nil)" : (x = "0x",
                                    S = E.toString(16)));
                                if (h)
                                    for (; S.length < b; )
                                        S = "0" + S;
                                for (u >= 0 && (f ? x = "+" + x : v && (x = " " + x)),
                                "-" == S.charAt(0) && (x = "-" + x,
                                S = S.substr(1)); x.length + S.length < g; )
                                    d ? S += " " : p ? S = "0" + S : x = " " + x;
                            ...
                            case "G":
                                ...
                                isNaN(u))
                                    ...
                                    if (103 == o || 71 == o) {
                                        ...
                                        b > A && A >= -4 ? (o = (103 == o ? "f" : "F").charCodeAt(0),
                                        b -= A + 1) : (o = (103 == o ? "e" : "E").charCodeAt(0),
                                        b--),
                                        F = Math.min(b, 20)
                                    }
                                    101 == o || 69 == o ? (S = u.toExponential(F),
                                    /[eE][-+]\d$/.test(S) && (S = S.slice(0, -1) + "0" + S.slice(-1))) : 102 != o && 70 != o || (S = u.toFixed(F),
                                    0 === u && ((s = u) < 0 || 0 === s && 1 / s == -1 / 0) && (S = "-" + S));
                                    var P = S.split("e");
                                    if (D && !m)
                                        for (; P[0].length > 1 && -1 != P[0].indexOf(".") && ("0" == P[0].slice(-1) || "." == P[0].slice(-1)); )
                                            P[0] = P[0].slice(0, -1);
                                    else
                                        for (m && -1 == S.indexOf(".") && (P[0] += "."); b > F++; )
                                            P[0] += "0";
                                    S = P[0] + (P.length > 1 ? "e" + P[1] : ""),
                                    69 == o && (S = S.toUpperCase()),
                                    u >= 0 && (f ? S = "+" + S : v && (S = " " + S))
                                } else
                                    S = (u < 0 ? "-" : "") + "inf",
                                    p = !1;
                                for (; S.length < g; )
                                    d ? S += " " : S = !p || "-" != S[0] && "+" != S[0] ? (p ? "0" : " ") + S : S[0] + "0" + S.slice(1);
                                o < 97 && (S = S.toUpperCase()),
                            ...
                            case "s":
                                ...
                                if (T)
                                    ...
                                    c = c.concat(Qr("(null)".substr(0, L), !0));
                                if (d)
                                    for (; L < g--; )
                                        c.push(32);
                                break;
                            case "c":
                                for (d && c.push(i("i8")); --g > 0; )
                                    c.push(32);
                                d || c.push(i("i8"));
                                break;
                            case "n":
            ...
            emscripten_memcpy_big: function(e, r, t) {
                O.copyWithin(e, r, r + t)
            },
            emscripten_request_fullscreen_strategy: function(e, r, t) {
                return function(e, r) {
                    return je.fullscreenEnabled() ? (e = ze(e)) ? e.requestFullscreen || e.webkitRequestFullscreen ? je.canPerformEventHandlerRequests() ? Ke(e, r) : r.deferUntilInEventHandler ? (je.deferCall(Ke, 1, [e, r]),
                    1) : -2 : -3 : -4 : -1
                }(e, {
                    scaleMode: q[t >> 2],
            ...
            emscripten_request_pointerlock: function(e, r) {
                return (e = ze(e)) ? e.requestPointerLock || e.msRequestPointerLock ? je.canPerformEventHandlerRequests() ? $e(e) : r ? (je.deferCall($e, 2, [e]),
                1) : -2 : -1 : -4
            },
            emscripten_resize_heap: function(e) {
                ...
                for (var n, i, a = 1; a <= 4; a *= 2) {
                    ...
                    hr(Math.min(t, ((n = Math.max(16777216, e, o)) % (i = 65536) > 0 && (n += i - n % i),
                    n))))
                        return !0
                }
                return !1
            ...
            emscripten_sample_gamepad_data: function() {
                return (je.lastGamepadState = navigator.getGamepads ? navigator.getGamepads() : navigator.webkitGetGamepads ? navigator.webkitGetGamepads() : null) ? 0 : -1
            },
            ...
            emscripten_set_mousedown_callback_on_thread: function(e, r, t, n, i) {
                return kr(e, r, t, n, 5, "mousedown"),
                0
            },
            emscripten_set_mouseenter_callback_on_thread: function(e, r, t, n, i) {
                return kr(e, r, t, n, 33, "mouseenter"),
                0
            },
            emscripten_set_mouseleave_callback_on_thread: function(e, r, t, n, i) {
                return kr(e, r, t, n, 34, "mouseleave"),
                0
            },
            emscripten_set_mousemove_callback_on_thread: function(e, r, t, n, i) {
                return kr(e, r, t, n, 8, "mousemove"),
                0
            },
            emscripten_set_mouseup_callback_on_thread: function(e, r, t, n, i) {
                return kr(e, r, t, n, 6, "mouseup"),
                0
            },
            emscripten_set_pointerlockchange_callback_on_thread: function(e, r, t, n, i) {
                return document && document.body && (document.body.requestPointerLock || document.body.mozRequestPointerLock || document.body.webkitRequestPointerLock || document.body.msRequestPointerLock) ? (e = ze(e)) ? (Cr(e, r, t, n, 20, "pointerlockchange"),
                Cr(e, r, t, n, 20, "mozpointerlockchange"),
                Cr(e, r, t, n, 20, "webkitpointerlockchange"),
                Cr(e, r, t, n, 20, "mspointerlockchange"),
                0) : -4 : -1
            },
            emscripten_set_resize_callback_on_thread: function(e, r, t, n, i) {
                return function(e, r, t, n, i, a, o) {
                    je.uiEvent || (je.uiEvent = Zr(36));
                    var u = {
                        target: e = ze(e),
                        eventTypeString: a,
                        callbackfunc: n,
                        handlerFunc: function(t) {
                            ...
                            if (a.target == e) {
                                var o = je.uiEvent
                                  , u = document.body;
                                q[o >> 2] = a.detail,
                                q[o + 4 >> 2] = u.clientWidth,
                                q[o + 8 >> 2] = u.clientHeight,
                                q[o + 12 >> 2] = innerWidth,
                                q[o + 16 >> 2] = innerHeight,
                                q[o + 20 >> 2] = outerWidth,
                                q[o + 24 >> 2] = outerHeight,
                                q[o + 28 >> 2] = pageXOffset,
                                q[o + 32 >> 2] = pageYOffset,
                                mt(n, i, o, r) && a.preventDefault()
                            }
                        },
                        useCapture: t
            ...
            emscripten_start_fetch: function(e, r, t, n, i) {
                ...
                if ("EM_IDB_STORE" === o) {
                    var w = Q[a + 84 >> 2];
                    Tr(Ar.dbInstance, e, O.slice(w, w + Q[a + 88 >> 2]), v, _)
                } else if ("EM_IDB_DELETE" === o)
                    !function(e, r, t, n) {
                        if (e) {
                            var i = Q[r + 112 + 64 >> 2];
                            i || (i = Q[r + 8 >> 2]);
                    ...
                    !function(e, r, t, n) {
                        if (e) {
                            ...
                            n(r, 0, "IndexedDB not available!")
                    }(Ar.dbInstance, e, v, m ? _ : d ? function(e, r, t) {
                        Pr(e, b, _, g, h)
                    }
                    : function(e, r, t) {
                        Pr(e, v, _, g, h)
            ...
            fd_seek: function(e, r, t, n, i) {
                try {
                    var a = Te.getStreamFromFD(e)
                      , o = 4294967296 * t + (r >>> 0)
                      , u = 9007199254740992;
                    return o <= -u || o >= u ? -61 : (Pe.llseek(a, o, n),
                    he = [a.position >>> 0, (_e = a.position,
                    +ae(_e) >= 1 ? _e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0 : 0)],
                    q[i >> 2] = he[0],
                    q[i + 4 >> 2] = he[1],
            ...
            gmtime_r: function(e, r) {
                var t = new Date(1e3 * q[e >> 2]);
                q[r >> 2] = t.getUTCSeconds(),
                q[r + 4 >> 2] = t.getUTCMinutes(),
                q[r + 8 >> 2] = t.getUTCHours(),
                q[r + 12 >> 2] = t.getUTCDate(),
                q[r + 16 >> 2] = t.getUTCMonth(),
                q[r + 20 >> 2] = t.getUTCFullYear() - 1900,
                q[r + 24 >> 2] = t.getUTCDay(),
                q[r + 36 >> 2] = 0,
                q[r + 32 >> 2] = 0;
            ...
            nanosleep: function(e, r) {
                ...
                var t = q[e >> 2]
                  , n = q[e + 4 >> 2];
                return n < 0 || n > 999999999 || t < 0 ? (xe(28),
                -1) : (0 !== r && (q[r >> 2] = 0,
                q[r + 4 >> 2] = 0),
                Nr(1e6 * t + n / 1e3))
            },
            ...
            saveSetjmp: function e(r, t, n, i) {
                ...
                return n = 0 | e(0 | r, 0 | t, 0 | (n = 0 | Kr(0 | n, 8 * ((i = 2 * i | 0) + 1 | 0) | 0)), 0 | i),
                x(0 | i),
                0 | n
            },
            ...
            testSetjmp: function(e, r, t) {
                ...
                r |= 0,
                t |= 0;
                for (var n = 0, i = 0; (0 | n) < (0 | t) && 0 != (0 | (i = 0 | q[r + (n << 3) >> 2])); ) {
                    if ((0 | i) == (0 | e))
                        return 0 | q[r + (4 + (n << 3)) >> 2];
                    n = n + 1 | 0
                }
                return 0
            },
            ...
            usleep: Nr,
            wafjs_external_transformExternalInterfaceCall: function(e, t) {
                function n(e) {
                    var r = typeof e;
                    return "string" == r ? `<string>${function(e) {
                        const r = {
                            "&": "&amp;",
                            "<": "&lt",
                            ">": "&gt",
                    ...
                    }(e)}</string>` : "undefined" == r ? "<undefined/>" : "number" == r ? `<number>${e}</number>` : null == e ? "<null/>" : "boolean" == r ? e ? "<true/>" : "<false/>" : e instanceof Date ? `<date>${e.getTime()}</date>` : e instanceof Array ? function(e) {
                ...
                const i = L(e)
                  , a = r.WAFLASH;
                let o = a && a.hal && "function" == typeof a.hal.external_transformExternalInterfaceCall && a.hal.external_transformExternalInterfaceCall(i, t);
                if (o) {
                    o = n(o);
                    const e = R(o) + 1
                      , r = Zr(e);
            ...
            wafjs_file_loaddata: function(e) {
                ...
                if (t && t.length > 0) {
                    ...
                    return r.HEAP8.set(e, n + 4),
                    r.HEAP32[n >> 2] = e.length,
                    n
                }
                return 0
            },
            ...
            wafjs_get_option_backgroundColor: function() {
                return parseInt(r.options.backgroundColor) || 0
            },
            wafjs_get_option_quality: function() {
                return ({
                    high: 3,
                    medium: 2,
                    low: 1
            ...
            wafjs_hal_inputtext_begin: function(e, t, n, i, a, o, u, s, c) {
                ...
                l.style.left = "50%",
                l.style.width = "32px",
                l.wafSelectionStart = l.wafSelectionEnd = l.value ? l.value.length : 0;
                let f = !1
                  , d = !1;
                const m = (e,r)=>{
                    ut(u, c, 0, e, r)
                ...
                l.addEventListener("input", (function(e) {
                    if ("insertCompositionText" != e.inputType || e.isComposing) {
                        if ("deleteContentForward" == e.inputType || "insertText" == e.inputType && null == e.data)
                            m(l.wafSelectionStart, l.wafSelectionEnd + 1);
                        else if ("deleteContentBackward" == e.inputType) {
                            if (l.wafSelectionStart <= 0)
                                return;
                            m(l.wafSelectionStart - 1, l.wafSelectionEnd),
                            l.wafSelectionEnd = --l.wafSelectionStart
                        } else {
                            const r = e.data || "";
                            let t = l.wafSelectionStart
                              , n = l.wafSelectionEnd;
                            e.isComposing ? (f ? (l.wafSelectionEnd = ++l.wafSelectionStart,
                            f = !1) : t -= 1,
                            r || (l.wafSelectionEnd = --l.wafSelectionStart)) : l.wafSelectionEnd = ++l.wafSelectionStart,
                            ((e,r,t)=>{
                                const n = R(e) + 1
                                  , i = Zr(n);
                                B(e, i, n),
                ...
                l.addEventListener("compositionupdate", (e=>{}
                )),
                l.addEventListener("compositionend", (e=>{}
                )),
                !r.canvas.inputTextFocusHandler && (r.canvas.inputTextFocusHandler = e=>{
                ...
                r.canvas.parentNode.appendChild(l),
                r.canvas.wafActiveInputText = l
            },
          ...
          , Xr = function() {
            ...
            return function() {
                if (b || "function" != typeof WebAssembly.instantiateStreaming || ve(be) || "function" != typeof fetch)
                    return i(n);
                fetch(be, {
                    credentials: "same-origin"
                }).then((function(r) {
        ...
        ,
        r.___em_js__wafjs_get_option_quality = function() {
            return (r.___em_js__wafjs_get_option_quality = r.asm.__em_js__wafjs_get_option_quality).apply(null, arguments)
        }
        ,
        r.___em_js__wafjs_get_option_backgroundColor = function() {
            return (r.___em_js__wafjs_get_option_backgroundColor = r.asm.__em_js__wafjs_get_option_backgroundColor).apply(null, arguments)
        }
        ,
        ...
        ,
        r.___em_js__wafjs_external_transformExternalInterfaceCall = function() {
            return (r.___em_js__wafjs_external_transformExternalInterfaceCall = r.asm.__em_js__wafjs_external_transformExternalInterfaceCall).apply(null, arguments)
        }
        ,
        r._fileno = function() {
        ...
        , _t = r.dynCall_iiiiiiii = function() {
            return (_t = r.dynCall_iiiiiiii = r.asm.dynCall_iiiiiiii).apply(null, arguments)
        }
        , ht = r.dynCall_iid = function() {
            return (ht = r.dynCall_iid = r.asm.dynCall_iid).apply(null, arguments)
        }
        ...
        ,
        r.addRunDependency = de,
        r.removeRunDependency = me,
        r.FS_createFolder = Pe.createFolder,
        r.FS_createPath = Pe.createPath,
        r.FS_createDataFile = Pe.createDataFile,
        r.FS_createPreloadedFile = Pe.createPreloadedFile,
        ...
        function kt(e) {
            function n() {
                ...
                r.calledRun = !0,
                S || (te = !0,
                r.noFSInit || Pe.init.initialized || Pe.init(),
                De.init(),
                Z($),
            ...
            ce > 0 || (r.setStatus ? (r.setStatus("Running..."),
            setTimeout((function() {
                setTimeout((function() {
                    r.setStatus("")
                }
