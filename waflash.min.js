var Module = (function () {
    ...
    return function (r) {
        ...
        ((r = void 0 !== (r = r || {}) ? r : {}).ready = new Promise(function (e, r) {
            ...
            (function (e) {
                ...
                "function" != typeof r.locateFilePackage ||
                    r.locateFile ||
                    ((r.locateFile = r.locateFilePackage), p("warning: you defined Module.locateFilePackage, that has been renamed to Module.locateFile (using your locateFilePackage for now)"));
                ...
                function f() {
                    ...
                    r.addRunDependency("datafile_waflash.data"), r.preloadResults || (r.preloadResults = {}), (r.preloadResults["waflash.data"] = { fromCache: !1 }), l ? (o(l), (l = null)) : (c = o);
                }
                l ||
                    ((a = n),
                    (o = i),
                    ...
                    (s.onprogress = function (e) {
                        ...
                        if ((e.total && (n = e.total), e.loaded)) {
                            s.addedTotal ? (r.dataFileDownloads[t].loaded = e.loaded) : ((s.addedTotal = !0), r.dataFileDownloads || (r.dataFileDownloads = {}), (r.dataFileDownloads[t] = { loaded: e.loaded, total: n }));
                            var i = 0,
                                u = 0,
                                c = 0;
                    ...
                    s.send(null)),
                    r.calledRun ? f() : (r.preRun || (r.preRun = []), r.preRun.push(f));
            })({
                files: [
                    { filename: "/desktop.ini", start: 0, end: 46, audio: 0 },
                    { filename: "/NanumSquareRoundOTFR.otf", start: 46, end: 465950, audio: 0 },
                ],
        ...
        function _(e) {
            _.shown || (_.shown = {}), _.shown[e] || ((_.shown[e] = 1), p(e));
        }
        function h(e, t, n) {
        ...
        function k(e, r, t, n) {
            switch (("*" === (t = t || "i8").charAt(t.length - 1) && (t = "i32"), t)) {
                ...
                case "i32":
                    ...
                    break;
                case "i64":
                    (he = [r >>> 0, ((_e = r), +ae(_e) >= 1 ? (_e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0) : 0)]), (q[e >> 2] = he[0]), (q[(e + 4) >> 2] = he[1]);
                    break;
                case "float":
                    V[e >> 2] = r;
                    break;
        ...
        var C = new WebAssembly.Table({ initial: 12768, maximum: 12768, element: "anyfunc" }),
            S = !1;
        function D(e, r) {
        ...
        (w = r.wasmMemory ? r.wasmMemory : new WebAssembly.Memory({ initial: Y / 65536, maximum: 32768 })) && (U = w.buffer), (Y = U.byteLength), H(U), (q[W >> 2] = 6298560);
        var K = [],
            $ = [],
            J = [],
            ee = [],
        ...
        var we = {
                ...
                return (
                    ...
                    (function (e, r, t, n) {
                        ...
                        if (((o = 3 == t ? n : [Zr, wt, v][t](Math.max(a, u ? 1 : r.length))), i)) {
                            ...
                            for (s = o + a; n < s; ) j[n++ >> 0] = 0;
                            return o;
                        }
                        if ("i8" === u) return e.subarray || e.slice ? O.set(e, o) : O.set(new Uint8Array(e), o), o;
            ...
            925260: function (e, t, n) {
                ...
                r.SDL2 || (r.SDL2 = {});
                var u = r.SDL2;
                u.ctxCanvas !== r.canvas && ((u.ctx = r.createContext(r.canvas, !1, !0)), (u.ctxCanvas = r.canvas)),
                    (u.w === i && u.h === a && u.imageCtx === u.ctx) || ((u.image = u.ctx.createImageData(i, a)), (u.w = i), (u.h = a), (u.imageCtx = u.ctx));
                var s,
                    c = u.image.data,
                    l = o >> 2,
                    f = 0;
            ...
            926739: function (e, r, t, n, i) {
                ...
                if ("undefined" != typeof CanvasPixelArray && p instanceof CanvasPixelArray)
                    for (f = p.length; g < f; ) {
                        var _ = q[v];
                        (p[g] = 255 & _), (p[g + 1] = (_ >> 8) & 255), (p[g + 2] = (_ >> 16) & 255), (p[g + 3] = (_ >> 24) & 255), v++, (g += 4);
                    }
                else {
                    var h = new Int32Array(p.buffer);
                    (f = h.length), h.set(q.subarray(v, v + f));
                }
            ...
            930290: function (e, t, n, i) {
                var a = r.SDL2,
                    o = function (r) {
                        void 0 !== a.capture.silenceTimer && (clearTimeout(a.capture.silenceTimer), (a.capture.silenceTimer = void 0)),
                            ...
                            (a.capture.scriptProcessorNode.onaudioprocess = function (e) {
                                void 0 !== a && void 0 !== a.capture && (e.outputBuffer.getChannelData(0).fill(0), (a.capture.currentCaptureBuffer = e.inputBuffer), h("vi", n, [i]));
                            }),
                ...
                (a.capture.silenceTimer = setTimeout(function () {
                    (a.capture.currentCaptureBuffer = a.capture.silenceBuffer), h("vi", n, [i]);
                }, (t / a.audioContext.sampleRate) * 1e3)),
                    void 0 !== navigator.mediaDevices && void 0 !== navigator.mediaDevices.getUserMedia
                        ? navigator.mediaDevices.getUserMedia({ audio: !0, video: !1 }).then(o).catch(u)
                        : void 0 !== navigator.webkitGetUserMedia && navigator.webkitGetUserMedia({ audio: !0, video: !1 }, o, u);
            },
            931942: function (e, t, n, i) {
                ...
                (a.audio.scriptProcessorNode = a.audioContext.createScriptProcessor(t, 0, e)),
                    (a.audio.scriptProcessorNode.onaudioprocess = function (e) {
                        void 0 !== a && void 0 !== a.audio && ((a.audio.currentOutputBuffer = e.outputBuffer), h("vi", n, [i]));
                    }),
            ...
            932352: function (e, t) {
                for (var n = r.SDL2, i = n.capture.currentCaptureBuffer.numberOfChannels, a = 0; a < i; ++a) {
                    ...
                    if (1 == i) for (var u = 0; u < t; ++u) k(e + 4 * u, o[u], "float");
                    else for (u = 0; u < t; ++u) k(e + 4 * (u * i + a), o[u], "float");
                }
            },
            932957: function (e, t) {
            ...
            933437: function (e) {
                ...
                if (e) {
                    ...
                    void 0 !== t.capture.scriptProcessorNode && ((t.capture.scriptProcessorNode.onaudioprocess = function (e) {}), t.capture.scriptProcessorNode.disconnect(), (t.capture.scriptProcessorNode = void 0)),
                        void 0 !== t.capture.mediaStreamNode && (t.capture.mediaStreamNode.disconnect(), (t.capture.mediaStreamNode = void 0)),
        ...
        var ke,
            ...
            De = {
                ...
                register: function (e, r) {
                    (De.ttys[e] = { input: [], output: [], ops: r }), Pe.registerDevice(e, De.stream_ops);
                },
                stream_ops: {
                    open: function (e) {
            ...
            Fe = {
                ...
                createNode: function (e, r, t, n) {
                    ...
                    Fe.ops_table ||
                        (Fe.ops_table = {
                            ...
                            file: {
                                node: { getattr: Fe.node_ops.getattr, setattr: Fe.node_ops.setattr },
                                stream: { llseek: Fe.stream_ops.llseek, read: Fe.stream_ops.read, write: Fe.stream_ops.write, allocate: Fe.stream_ops.allocate, mmap: Fe.stream_ops.mmap, msync: Fe.stream_ops.msync },
                            },
                            link: { node: { getattr: Fe.node_ops.getattr, setattr: Fe.node_ops.setattr, readlink: Fe.node_ops.readlink }, stream: {} },
                            chrdev: { node: { getattr: Fe.node_ops.getattr, setattr: Fe.node_ops.setattr }, stream: Pe.chrdev_stream_ops },
                        });
                    var i = Pe.createNode(e, r, t, n);
                    return (
                        Pe.isDir(i.mode)
                            ? ((i.node_ops = Fe.ops_table.dir.node), (i.stream_ops = Fe.ops_table.dir.stream), (i.contents = {}))
                            : Pe.isFile(i.mode)
                            ? ((i.node_ops = Fe.ops_table.file.node), (i.stream_ops = Fe.ops_table.file.stream), (i.usedBytes = 0), (i.contents = null))
                            : Pe.isLink(i.mode)
                            ? ((i.node_ops = Fe.ops_table.link.node), (i.stream_ops = Fe.ops_table.link.stream))
                            : Pe.isChrdev(i.mode) && ((i.node_ops = Fe.ops_table.chrdev.node), (i.stream_ops = Fe.ops_table.chrdev.stream)),
                ...
                node_ops: {
                    getattr: function (e) {
                        var r = {};
                        return (
                            (r.dev = Pe.isChrdev(e.mode) ? e.id : 1),
                            (r.ino = e.id),
                            (r.mode = e.mode),
                            (r.nlink = 1),
                            (r.uid = 0),
                    ...
                    rename: function (e, r, t) {
                        if (Pe.isDir(e.mode)) {
                            ...
                            if (n) for (var i in n.contents) throw new Pe.ErrnoError(55);
                        }
                ...
                stream_ops: {
                    read: function (e, r, t, n, i) {
                        ...
                        else for (var u = 0; u < o; u++) r[t + u] = a[i + u];
                        return o;
                    },
                    write: function (e, r, t, n, i, a) {
                        if ((r.buffer === j.buffer && (a = !1), !n)) return 0;
                        var o = e.node;
                        ...
                        else for (var u = 0; u < n; u++) o.contents[i + u] = r[t + u];
            ...
            Ae = {
                ...
                getDB: function (e, r) {
                    ...
                    (t.onupgradeneeded = function (e) {
                        ...
                        (r = t.objectStoreNames.contains(Ae.DB_STORE_NAME) ? n.objectStore(Ae.DB_STORE_NAME) : t.createObjectStore(Ae.DB_STORE_NAME)).indexNames.contains("timestamp") ||
                ...
                getLocalSet: function (e, r) {
                    ...
                    for (var a = Pe.readdir(e.mountpoint).filter(n).map(i(e.mountpoint)); a.length; ) {
                        ...
                        Pe.isDir(o.mode) && a.push.apply(a, Pe.readdir(u).filter(n).map(i(u))), (t[u] = { timestamp: o.mtime });
                    }
                        ...
                        try {
                            ...
                            (i.onerror = function (e) {
                                ...
                                (i.objectStore(Ae.DB_STORE_NAME).index("timestamp").openKeyCursor().onsuccess = function (e) {
                                    ...
                                    if (!i) return r(null, { type: "remote", db: n, entries: t });
                ...
                loadLocalEntry: function (e, r) {
                    ...
                    return Pe.isDir(t.mode)
                        ? r(null, { timestamp: t.mtime, mode: t.mode })
                        : Pe.isFile(t.mode)
                        ? ((n.contents = Fe.getFileDataAsTypedArray(n)), r(null, { timestamp: t.mtime, mode: t.mode, contents: n.contents }))
                ...
                storeLocalEntry: function (e, r, t) {
                    try {
                        if (Pe.isDir(r.mode)) Pe.mkdir(e, r.mode);
                            ...
                            Pe.writeFile(e, r.contents, { canOwn: !0 });
                        }
                ...
                reconcile: function (e, r, t) {
                    ...
                    (u.onerror = function (e) {
                        ...
                        i.sort().forEach(function (e) {
                            "local" === r.type
                                ? Ae.loadRemoteEntry(s, e, function (r, t) {
                                      if (r) return c(r);
            ...
            Pe = {
                    ...
                    for (
                        ...
                        if (((a = Pe.lookupNode(a, i[u])), (o = Ce.join2(o, i[u])), Pe.isMountpoint(a) && (!s || (s && r.follow_mount)) && (a = a.mounted.root), !s || r.follow))
                            for (var c = 0; Pe.isLink(a.mode); ) {
                                var l = Pe.readlink(o);
                                if (((o = Se.resolve(Ce.dirname(o), l)), (a = Pe.lookupPath(o, { recurse_count: r.recurse_count }).node), c++ > 40)) throw new Pe.ErrnoError(32);
                            }
                    }
                ...
                nextfd: function (e, r) {
                    ...
                    for (var t = e; t <= r; t++) if (!Pe.streams[t]) return t;
                ...
                mount: function (e, r, t) {
                    ...
                    if (!i && !a) {
                        var o = Pe.lookupPath(t, { follow_mount: !1 });
                ...
                unmount: function (e) {
                    var r = Pe.lookupPath(e, { follow_mount: !1 });
                    ...
                    Object.keys(Pe.nameTable).forEach(function (e) {
                        for (var r = Pe.nameTable[e]; r; ) {
                            var t = r.name_next;
                            -1 !== i.indexOf(r.mount) && Pe.destroyNode(r), (r = t);
                        }
                    }),
                        (t.mounted = null);
                ...
                mknod: function (e, r, t) {
                    var n = Pe.lookupPath(e, { parent: !0 }).node,
                        i = Ce.basename(e);
                ...
                symlink: function (e, r) {
                    ...
                    var t = Pe.lookupPath(r, { parent: !0 }).node;
                ...
                rename: function (e, r) {
                    var t,
                        ...
                        u = Ce.basename(r);
                    try {
                        (t = Pe.lookupPath(e, { parent: !0 }).node), (n = Pe.lookupPath(r, { parent: !0 }).node);
                    } catch (e) {
                ...
                stat: function (e, r) {
                    var t = Pe.lookupPath(e, { follow: !r }).node;
                    if (!t) throw new Pe.ErrnoError(44);
                ...
                chmod: function (e, r, t) {
                    var n;
                    "string" == typeof e ? (n = Pe.lookupPath(e, { follow: !t }).node) : (n = e);
                ...
                chown: function (e, r, t, n) {
                    var i;
                    "string" == typeof e ? (i = Pe.lookupPath(e, { follow: !n }).node) : (i = e);
                ...
                truncate: function (e, r) {
                    ...
                    var t;
                    "string" == typeof e ? (t = Pe.lookupPath(e, { follow: !0 }).node) : (t = e);
                ...
                utime: function (e, r, t) {
                    var n = Pe.lookupPath(e, { follow: !0 }).node;
                ...
                open: function (e, t, n, i, a) {
                    ...
                    if (((n = void 0 === n ? 438 : n), (n = 64 & (t = "string" == typeof t ? Pe.modeStringToFlags(t) : t) ? (4095 & n) | 32768 : 0), "object" == typeof e)) o = e;
                        ...
                        e = Ce.normalize(e);
                        try {
                            o = Pe.lookupPath(e, { follow: !(131072 & t) }).node;
                        } catch (e) {}
                    }
                    var u = !1;
                    if (64 & t)
                    ...
                    var c = Pe.createStream({ node: o, path: Pe.getPath(o), flags: t, seekable: !0, position: 0, stream_ops: o.stream_ops, ungotten: [], error: !1 }, i, a);
                ...
                chdir: function (e) {
                    var r = Pe.lookupPath(e, { follow: !0 });
                ...
                staticInit: function () {
                    Pe.ensureErrnoError(), (Pe.nameTable = new Array(4096)), Pe.mount(Fe, {}, "/"), Pe.createDefaultDirectories(), Pe.createDefaultDevices(), Pe.createSpecialDirectories(), (Pe.filesystems = { MEMFS: Fe, IDBFS: Ae });
                },
                init: function (e, t, n) {
                ...
                createLazyFile: function (e, r, t, n, i) {
                    ...
                    if (
                        ...
                        (a.prototype.cacheLength = function () {
                            ...
                            u.setDataGetter(function (e) {
                                ...
                                (!a && n) || ((o = n = 1), (n = this.getter(0).length), (o = n), m("LazyFiles on gzip forces download of the whole file when length is accessed")),
                                (this._length = n),
                                (this._chunkSize = o),
                                (this.lengthKnown = !0);
                        }),
                    ...
                    var o = { isDevice: !1, url: t },
                        u = Pe.createFile(e, r, o, n, i);
                    o.contents ? (u.contents = o.contents) : o.url && ((u.contents = null), (u.url = o.url)),
            ...
            Te = {
                ...
                doStat: function (e, r, t) {
                    ...
                    return (
                        ...
                        (q[(t + 28) >> 2] = n.rdev),
                        (q[(t + 32) >> 2] = 0),
                        (he = [n.size >>> 0, ((_e = n.size), +ae(_e) >= 1 ? (_e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0) : 0)]),
                        (q[(t + 40) >> 2] = he[0]),
                        (q[(t + 44) >> 2] = he[1]),
                        (q[(t + 48) >> 2] = 4096),
                        (q[(t + 52) >> 2] = n.blocks),
                        ...
                        (q[(t + 76) >> 2] = 0),
                        (he = [n.ino >>> 0, ((_e = n.ino), +ae(_e) >= 1 ? (_e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0) : 0)]),
                        (q[(t + 80) >> 2] = he[0]),
                        (q[(t + 84) >> 2] = he[1]),
                        0
                    );
                ...
                doReadlink: function (e, r, t) {
                    ...
                    var n = Pe.readlink(e),
                        i = Math.min(t, R(n)),
                        a = j[r + i];
                    return B(n, r, t + 1), (j[r + i] = a), i;
                },
                doAccess: function (e, r) {
                    if (-8 & r) return -28;
                    var t;
                    if (!(t = Pe.lookupPath(e, { follow: !0 }).node)) return -44;
                    var n = "";
                    ...
                    if (!S)
                        if (Be.mainLoop.queue.length > 0) {
                            ...
                            if ((r.func(r.arg), Be.mainLoop.remainingBlockers)) {
                                ...
                                r.counted ? (Be.mainLoop.remainingBlockers = n) : ((n += 0.5), (Be.mainLoop.remainingBlockers = (8 * t + n) / 9));
                            }
                            ...
                            u < Be.mainLoop.currentlyRunningMainloop ||
                                ((Be.mainLoop.currentFrameNumber = (Be.mainLoop.currentFrameNumber + 1) | 0),
                                1 == Be.mainLoop.timingMode && Be.mainLoop.timingValue > 1 && Be.mainLoop.currentFrameNumber % Be.mainLoop.timingValue != 0
                                    ? Be.mainLoop.scheduler()
                                    : (0 == Be.mainLoop.timingMode && (Be.mainLoop.tickStartTime = ke()),
                                      Be.mainLoop.runIter(o),
                                      u < Be.mainLoop.currentlyRunningMainloop || ("object" == typeof SDL && SDL.audio && SDL.audio.queueNewAudioData && SDL.audio.queueNewAudioData(), Be.mainLoop.scheduler())));
                }),
                a || (t && t > 0 ? Le(0, 1e3 / t) : Le(1, 1), Be.mainLoop.scheduler()),
                n)
            )
                throw "unwind";
        }
        ...
        var Be = {
                ...
                init: function () {
                    if ((r.preloadPlugins || (r.preloadPlugins = []), !Be.initted)) {
                        ...
                        (Be.BlobBuilder = "undefined" != typeof MozBlobBuilder ? MozBlobBuilder : "undefined" != typeof WebKitBlobBuilder ? WebKitBlobBuilder : Be.hasBlobConstructor ? null : console.log("warning: no BlobBuilder")),
                            ...
                            r.noImageDecoding || void 0 !== Be.URLObject || (console.log("warning: Browser does not support creating object URLs. Built-in browser image decoding will not be available."), (r.noImageDecoding = !0));
                        var e = {
                            ...
                            handle: function (e, t, n, i) {
                                ...
                                if (Be.hasBlobConstructor)
                                    try {
                                        (a = new Blob([e], { type: Be.getMimetype(t) })).size !== e.length && (a = new Blob([new Uint8Array(e).buffer], { type: Be.getMimetype(t) }));
                                    } catch (e) {
                        ...
                        var t = {
                            ...
                            handle: function (e, t, n, i) {
                                ...
                                try {
                                    var s = new Blob([e], { type: Be.getMimetype(t) });
                                } catch (e) {
                                    return u();
                                }
                ...
                createContext: function (e, t, n, i) {
                    ...
                    var a, o;
                    if (t) {
                        var u = { antialias: !1, alpha: !1, majorVersion: 2 };
                        if (i) for (var s in i) u[s] = i[s];
                        void 0 !== Ue && (o = Ue.createContext(e, u)) && (a = Ue.getContext(o).GLctx);
                    } else a = e.getContext("2d");
                    return a
                        ? (n &&
                              (t || D(void 0 === jr, "cannot set in module if GLctx is used, but we are a non-GL context that would replace it"),
                              (r.ctx = a),
                ...
                requestFullscreen: function (e, t) {
                    ...
                    function i() {
                        ...
                        (document.fullscreenElement || document.mozFullScreenElement || document.msFullscreenElement || document.webkitFullscreenElement || document.webkitCurrentFullScreenElement) === e
                            ? ((n.exitFullscreen = Be.exitFullscreen), Be.lockPointer && n.requestPointerLock(), (Be.isFullscreen = !0), Be.resizeCanvas ? Be.setFullscreenCanvasSize() : Be.updateCanvasDimensions(n))
                            : (e.parentNode.insertBefore(n, e), e.parentNode.removeChild(e), Be.resizeCanvas ? Be.setWindowedCanvasSize() : Be.updateCanvasDimensions(n)),
                            r.onFullScreen && r.onFullScreen(Be.isFullscreen),
                            r.onFullscreen && r.onFullscreen(Be.isFullscreen);
                    }
                    Be.fullscreenHandlersInstalled ||
                        ((Be.fullscreenHandlersInstalled = !0),
                ...
                exitFullscreen: function () {
                    return (
                        !!Be.isFullscreen && ((document.exitFullscreen || document.cancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen || document.webkitCancelFullScreen || function () {}).apply(document, []), !0)
                    );
                },
                nextRAF: 0,
                ...
                calculateMouseEvent: function (e) {
                    if (Be.pointerLock)
                        "mousemove" != e.type && "mozMovementX" in e ? (Be.mouseMovementX = Be.mouseMovementY = 0) : ((Be.mouseMovementX = Be.getMovementX(e)), (Be.mouseMovementY = Be.getMovementY(e))),
                            "undefined" != typeof SDL ? ((Be.mouseX = SDL.mouseX + Be.mouseMovementX), (Be.mouseY = SDL.mouseY + Be.mouseMovementY)) : ((Be.mouseX += Be.mouseMovementX), (Be.mouseY += Be.mouseMovementY));
                    else {
                        ...
                        if ("touchstart" === e.type || "touchend" === e.type || "touchmove" === e.type) {
                            ...
                            var s = u.pageX - (a + t.left),
                                c = u.pageY - (o + t.top),
                                l = { x: (s *= n / t.width), y: (c *= i / t.height) };
                ...
                updateCanvasDimensions: function (e, t, n) {
                    ...
                    var i = t,
                        a = n;
                    if (
                        (r.forcedAspectRatio && r.forcedAspectRatio > 0 && (i / a < r.forcedAspectRatio ? (i = Math.round(a * r.forcedAspectRatio)) : (a = Math.round(i / r.forcedAspectRatio))),
                    ...
                    Be.resizeCanvas
                        ? (e.width != i && (e.width = i), e.height != a && (e.height = a), void 0 !== e.style && (e.style.removeProperty("width"), e.style.removeProperty("height")))
                        : (e.width != t && (e.width = t),
                          e.height != n && (e.height = n),
                          void 0 !== e.style &&
                              (i != t || a != n ? (e.style.setProperty("width", i + "px", "important"), e.style.setProperty("height", a + "px", "important")) : (e.style.removeProperty("width"), e.style.removeProperty("height"))));
                },
                wgetRequests: {},
            ...
            Re = {
                ...
                AL_EXTENSIONS: { AL_EXT_float32: !0, AL_SOFT_loop_points: !0, AL_SOFT_source_length: !0, AL_EXT_source_distance_model: !0, AL_SOFT_source_spatialize: !0 },
                _alcErr: 0,
                alcErr: 0,
                deviceRefCounts: {},
                alcStringCache: {},
                ...
                scheduleContextAudio: function (e) {
                    if (1 !== Be.mainLoop.timingMode || "visible" == document.visibilityState) for (var r in e.sources) Re.scheduleSourceAudio(e.sources[r]);
                },
                        ...
                        for (var u = t + r, s = 0; n < u; ) {
                            ...
                            if (0 === c.length) {
                                ...
                                ((l = e.context.audioCtx.createBufferSource()).buffer = c.audioBuf),
                                    ...
                                    (c.audioBuf._loopStart || c.audioBuf._loopEnd) && ((l.loopStart = c.audioBuf._loopStart), (l.loopEnd = c.audioBuf._loopEnd));
                                var f = 0;
                                4136 === e.type && e.looping
                                    ? ((f = Number.POSITIVE_INFINITY), (l.loop = !0), c.audioBuf._loopStart && (l.loopStart = c.audioBuf._loopStart), c.audioBuf._loopEnd && (l.loopEnd = c.audioBuf._loopEnd))
                                    : (f = (c.audioBuf.duration - i) / e.playbackRate),
                                    (l._startOffset = i),
                                    (l._duration = f),
                                    (l._skipCount = s),
                                    (s = 0),
                                    l.connect(e.gain),
                                    void 0 !== l.start ? ((n = Math.max(n, e.context.audioCtx.currentTime)), l.start(n, i)) : void 0 !== l.noteOn && ((n = Math.max(n, e.context.audioCtx.currentTime)), l.noteOn(n)),
                                    (l._startTime = n),
                                    e.audioQueue.push(l),
                                    (n += f);
                            }
                ...
                setSourceState: function (e, r) {
                    4114 === r
                        ? ((4114 !== e.state && 4116 != e.state) || ((e.bufsProcessed = 0), (e.bufOffset = 0)), Re.stopSourceAudio(e), (e.state = 4114), (e.bufStartTime = Number.NEGATIVE_INFINITY), Re.scheduleSourceAudio(e))
                        : 4115 === r
                        ? 4114 === e.state && (Re.updateSourceTime(e), Re.stopSourceAudio(e), (e.state = 4115))
                        : 4116 === r
                        ? 4113 !== e.state && ((e.state = 4116), (e.bufsProcessed = e.bufQueue.length), (e.bufStartTime = Number.NEGATIVE_INFINITY), (e.bufOffset = 0), Re.stopSourceAudio(e))
                        : 4113 === r && 4113 !== e.state && ((e.state = 4113), (e.bufsProcessed = 0), (e.bufStartTime = Number.NEGATIVE_INFINITY), (e.bufOffset = 0), Re.stopSourceAudio(e));
                },
                ...
                updateListenerSpace: function (e) {
                    ...
                    for (var t in (r.positionX
                        ? ((r.positionX.value = e.listener.position[0]), (r.positionY.value = e.listener.position[1]), (r.positionZ.value = e.listener.position[2]))
                ...
                updateSourceSpace: function (e) {
                    if (e.panner) {
                        ...
                        r.positionX ? ((r.positionX.value = t), (r.positionY.value = n), (r.positionZ.value = i)) : r.setPosition(t, n, i),
                            r.orientationX ? ((r.orientationX.value = a), (r.orientationY.value = o), (r.orientationZ.value = u)) : r.setOrientation(a, o, u);
                        ...
                        if ((t === c && n === l && i === f) || (D === P && F === T && A === L)) e.dopplerShift = 1;
                            ...
                            var I = e.context.speedOfSound,
                                ...
                                j = (R * P + M * T + N * L) / U,
                                O = (R * D + M * F + N * A) / U;
                            (j = Math.min(j, I / B)), (O = Math.min(O, I / B)), (e.dopplerShift = (I - B * j) / (I - B * O));
                        }
                                ...
                                switch (t) {
                                    ...
                                    case 4103:
                                        if (1 === n) {
                                            ...
                                            i.looping = !1;
                                            var a,
                                                o = Re.updateSourceTime(i);
                                            4136 === i.type &&
                                                i.audioQueue.length > 0 &&
                                                (((a = i.audioQueue[0]).loop = !1), (a._duration = i.bufQueue[0].audioBuf.duration / i.playbackRate), (a._startTime = o - i.bufOffset / i.playbackRate));
                                        }
                                        break;
                                    case 4105:
        ...
        var Ue = {
            ...
            makeContextCurrent: function (e) {
                return (Ue.currentContext = Ue.contexts[e]), (r.ctx = jr = Ue.currentContext && Ue.currentContext.GLctx), !(e && !jr);
            },
            ...
            populateUniformTable: function (e) {
                for (var r = Ue.programs[e], t = (Ue.programInfos[e] = { uniforms: {}, maxUniformLength: 0, maxAttributeLength: -1, maxUniformBlockNameLength: -1 }), n = t.uniforms, i = jr.getProgramParameter(r, 35718), a = 0; a < i; ++a) {
                    ...
                    if (s) {
                        ...
                        for (var l = 1; l < o.size; ++l) {
                            var f = u + "[" + l + "]";
                            (s = jr.getUniformLocation(r, f)), (c = Ue.getNewId(Ue.uniforms)), (Ue.uniforms[c] = s);
                        }
                    }
                }
            },
        ...
        var je = {
                ...
                removeAllEventListeners: function () {
                    for (var e = je.eventHandlers.length - 1; e >= 0; --e) je._removeHandler(e);
                    (je.eventHandlers = []), (je.deferredCalls = []);
                },
                registerRemoveEventListeners: function () {
                    je.removeEventListenersRegistered || (ee.push(je.removeAllEventListeners), (je.removeEventListenersRegistered = !0));
                },
                deferredCalls: [],
                deferCall: function (e, r, t) {
                    ...
                    je.deferredCalls.push({ targetFunction: e, precedence: r, argsList: t }),
                        je.deferredCalls.sort(function (e, r) {
                            return e.precedence < r.precedence;
                        });
                },
                removeDeferredCalls: function (e) {
                    for (var r = 0; r < je.deferredCalls.length; ++r) je.deferredCalls[r].targetFunction == e && (je.deferredCalls.splice(r, 1), --r);
                },
                ...
                runDeferredCalls: function () {
                    if (je.canPerformEventHandlerRequests())
                        for (var e = 0; e < je.deferredCalls.length; ++e) {
                            ...
                            je.deferredCalls.splice(e, 1), --e, r.targetFunction.apply(null, r.argsList);
                        }
                },
                inEventHandler: 0,
                ...
                removeAllHandlersOnTarget: function (e, r) {
                    for (var t = 0; t < je.eventHandlers.length; ++t) je.eventHandlers[t].target != e || (r && r != je.eventHandlers[t].eventTypeString) || je._removeHandler(t--);
                },
                _removeHandler: function (e) {
                    var r = je.eventHandlers[e];
                    r.target.removeEventListener(r.eventTypeString, r.eventListenerFunc, r.useCapture), je.eventHandlers.splice(e, 1);
                },
                registerOrRemoveHandler: function (e) {
                    var r = function (r) {
                        ++je.inEventHandler, (je.currentEventHandler = e), je.runDeferredCalls(), e.handlerFunc(r), je.runDeferredCalls(), --je.inEventHandler;
                    };
                    if (e.callbackfunc) (e.eventListenerFunc = r), e.target.addEventListener(e.eventTypeString, r, e.useCapture), je.eventHandlers.push(e), je.registerRemoveEventListeners();
                    else for (var t = 0; t < je.eventHandlers.length; ++t) je.eventHandlers[t].target == e.target && je.eventHandlers[t].eventTypeString == e.eventTypeString && je._removeHandler(t--);
                },
        ...
        function ze(e) {
            var r;
            return (e = (r = e) > 2 ? L(r) : r), Ge[e] || document.querySelector(e);
        }
        function qe(e) {
            return ze(e);
        }
        ...
        function Ye(e) {
            return Ge.indexOf(e) < 0 ? e.getBoundingClientRect() : { left: 0, top: 0 };
        }
        function Ze(e, r) {
            var t = (function (e) {
                    var r = Ve(e),
        ...
        function Ke(e, r) {
            if (((0 == r.scaleMode && 0 == r.canvasResolutionScaleMode) || Ze(e, r), e.requestFullscreen)) e.requestFullscreen();
                ...
                if (!e.webkitRequestFullscreen) return je.fullscreenEnabled() ? -3 : -1;
                e.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT);
            }
            return (Oe = r), r.canvasResizedCallback && mt(r.canvasResizedCallback, 37, 0, r.canvasResizedCallbackUserData), 0;
        }
        function $e(e) {
        ...
        function Je(e) {
            var r = document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement,
                t = !!r;
            (q[e >> 2] = t), (q[(e + 4) >> 2] = je.fullscreenEnabled());
        ...
        function pr(e, r, t, n, i, a) {
            var o = dr(e),
                ...
                c = (function (e, r, t, n) {
                    ...
                    n,
                    (function (e) {
                        return { 5: 3, 6: 4, 8: 2, 29502: 3, 29504: 4, 26917: 2, 26918: 2, 29846: 3, 29847: 4 }[e - 6402] || 1;
                    })(r) * s,
                    Ue.unpackAlignment
                );
                    ...
                    (function (e) {
                        ...
                        (r = r.slice(i)),
                            8 & e &&
                                ...
                                (e |= 16));
                        var a = null;
                        if (128 & e) for (a = vr(arguments); a[1].indexOf("_emscripten_") >= 0; ) a = vr(a[0]);
                        var o = r.split("\n");
                        r = "";
                        ...
                        for (var l in o) {
                            ...
                            var b = !1;
                            if (8 & e) {
                                var y = emscripten_source_map.originalPositionFor({ line: p, column: v });
                                (b = y && y.source) && (64 & e && (y.source = y.source.substring(y.source.replace(/\\/g, "/").lastIndexOf("/") + 1)), (r += "    at " + h + " (" + y.source + ":" + y.line + ":" + y.column + ")\n"));
                            }
        ...
        function xr(e, r, t) {
            ...
            var a = Ye(t);
            (q[(e + 44) >> 2] = r.clientX - a.left), (q[(e + 48) >> 2] = r.clientY - a.top), "wheel" !== r.type && "mousewheel" !== r.type && ((je.previousScreenX = r.screenX), (je.previousScreenY = r.screenY));
        }
        function kr(e, r, t, n, i, a, o) {
            ...
            var u = {
                ...
                handlerFunc: function (t) {
                    var a = t || event;
                    xr(je.mouseEvent, a, e), mt(n, i, je.mouseEvent, r) && a.preventDefault();
                },
                useCapture: t,
            };
            je.registerOrRemoveHandler(u);
            ...
            var u = {
                ...
                handlerFunc:
                    "wheel" == a
                        ...
                        : function (t) {
                              var a = t || event;
                              xr(je.wheelEvent, a, e), (X[(je.wheelEvent + 64) >> 3] = a.wheelDeltaX || 0);
                              var o = -(a.wheelDeltaY || a.wheelDelta);
                              (X[(je.wheelEvent + 72) >> 3] = o), (X[(je.wheelEvent + 80) >> 3] = 0), (q[(je.wheelEvent + 88) >> 2] = 0), mt(n, i, je.wheelEvent, r) && a.preventDefault();
                          },
                useCapture: t,
            };
            je.registerOrRemoveHandler(u);
            ...
            if (a) {
                ...
                (k.onload = function (n) {
                    var i = k.response ? k.response.byteLength : 0,
                        a = 0,
                        o = 0;
                    h && !b && ((a = Zr((o = i))), O.set(new Uint8Array(k.response), a)),
                        (Q[(e + 12) >> 2] = a),
                        Ar.setu64(e + 16, o),
                        Ar.setu64(e + 24, 0),
                        i && Ar.setu64(e + 32, i),
                    ...
                    (k.onprogress = function (r) {
                        var t = h && b && k.response ? k.response.byteLength : 0,
                            i = 0;
                        h && b && ((i = Zr(t)), O.set(new Uint8Array(k.response), i)),
                            (Q[(e + 12) >> 2] = i),
                            Ar.setu64(e + 16, t),
        ...
        var Br = (B("GMT", 1055568, 4), 1055568);
        function Rr() {
            if (!Rr.called) {
        ...
        function Ur(e, r) {
            ...
            var t,
                n = Ur.array;
            for (n.length = 0; (t = O[e++]); ) 100 === t || 102 === t ? ((r = (r + 7) & -8), n.push(X[r >> 3]), (r += 8)) : ((r = (r + 3) & -4), n.push(q[r >> 2]), (r += 4));
            return n;
        }
        var jr,
            Or = function (e, r, t, n) {
        ...
        var Vr = {
                __cxa_atexit: function (e, r) {
                    return (t = e), (n = r), void ee.unshift({ func: t, arg: n });
                    var t, n;
                },
                        ...
                        if (a)
                            if (i <= 0) Re.currentCtx.err = 40963;
                                ...
                                try {
                                    switch (r) {
                                        case 4352:
                                            if (n > 0) for (var u = (o = Re.currentCtx.audioCtx.createBuffer(1, n, i)).getChannelData(0), s = 0; s < n; ++s) u[s] = 0.0078125 * O[t++] - 1;
                                        ...
                                        case 4353:
                                            if (n > 0) {
                                                ...
                                                t >>= 1;
                                                for (s = 0; s < n >> 1; ++s) u[s] = 30517578125e-15 * G[t++];
                                            }
                                        ...
                                        case 4354:
                                            if (n > 0) {
                                                ...
                                                for (s = 0; s < n >> 1; ++s) (u[s] = 0.0078125 * O[t++] - 1), (c[s] = 0.0078125 * O[t++] - 1);
                                            }
                                        ...
                                        case 4355:
                                            if (n > 0) {
                                                ...
                                                t >>= 1;
                                                for (s = 0; s < n >> 2; ++s) (u[s] = 30517578125e-15 * G[t++]), (c[s] = 30517578125e-15 * G[t++]);
                                            }
                ...
                alGenBuffers: function (e, r) {
                    if (Re.currentCtx)
                        for (var t = 0; t < e; ++t) {
                            var n = { deviceId: Re.currentCtx.deviceId, id: Re.newId(), refCount: 0, audioBuf: null, frequency: 0, bytesPerSample: 2, channels: 1, length: 0 };
                ...
                alcCreateContext: function (e, t) {
                    ...
                    var n = null,
                        ...
                        a = null;
                    if ((t >>= 2))
                        for (var o = 0, u = 0; (o = q[t++]), i.push(o), 0 !== o; )
                            switch (((u = q[t++]), i.push(u), o)) {
                                case 4103:
                                    n || (n = {}), (n.sampleRate = u);
                                    break;
                                case 4112:
                ...
                eglDestroySurface: function (e, r) {
                    return 62e3 != e
                        ...
                        : (Ne.currentReadSurface == r && (Ne.currentReadSurface = 0), Ne.currentDrawSurface == r && (Ne.currentDrawSurface = 0), Ne.setErrorCode(12288), 1);
                },
                ...
                eglMakeCurrent: function (e, r, t, n) {
                    return 62e3 != e
                        ...
                        : (Ue.makeContextCurrent(n ? Ne.context : null), (Ne.currentContext = n), (Ne.currentDrawSurface = r), (Ne.currentReadSurface = t), Ne.setErrorCode(12288), 1);
                },
                ...
                emscripten_exit_fullscreen: function () {
                    if (!je.fullscreenEnabled()) return -1;
                ...
                emscripten_exit_pointerlock: function () {
                    if ((je.removeDeferredCalls($e), document.exitPointerLock)) document.exitPointerLock();
                    else {
                ...
                emscripten_get_canvas_element_id: function (e) {
                    ...
                    r.ga("event", n, { event_category: "license", event_label: i, non_interaction: !0, send_to: r.gid });
                },
                ...
                emscripten_get_fullscreen_status: function (e) {
                    return je.fullscreenEnabled() ? (Je(e), 0) : -1;
                },
                emscripten_get_gamepad_status: function (e, r) {
                    return e < 0 || e >= je.lastGamepadState.length ? -5 : je.lastGamepadState[e] ? (er(r, je.lastGamepadState[e]), 0) : -7;
                },
                ...
                emscripten_glBindBuffer: function (e, r) {
                    35051 == e ? (jr.currentPixelPackBufferBinding = r) : 35052 == e && (jr.currentPixelUnpackBufferBinding = r), jr.bindBuffer(e, Ue.buffers[r]);
                },
                ...
                emscripten_glCompressedTexImage2D: function (e, r, t, n, i, a, o, u) {
                    Ue.currentContext.version >= 2
                        ? jr.currentPixelUnpackBufferBinding
                            ? jr.compressedTexImage2D(e, r, t, n, i, a, o, u)
                            : jr.compressedTexImage2D(e, r, t, n, i, a, O, u, o)
                        : jr.compressedTexImage2D(e, r, t, n, i, a, u ? O.subarray(u, u + o) : null);
                },
                ...
                emscripten_glCompressedTexSubImage2D: function (e, r, t, n, i, a, o, u, s) {
                    Ue.currentContext.version >= 2
                        ? jr.currentPixelUnpackBufferBinding
                            ? jr.compressedTexSubImage2D(e, r, t, n, i, a, o, u, s)
                            : jr.compressedTexSubImage2D(e, r, t, n, i, a, o, O, s, u)
                        : jr.compressedTexSubImage2D(e, r, t, n, i, a, o, s ? O.subarray(s, s + u) : null);
                },
                ...
                emscripten_glCreateShader: function (e) {
                    ...
                    return (Ue.shaders[r] = jr.createShader(e)), r;
                },
                ...
                emscripten_glDeleteFramebuffers: function (e, r) {
                    for (var t = 0; t < e; ++t) {
                        var n = q[(r + 4 * t) >> 2],
                            i = Ue.framebuffers[n];
                        i && (jr.deleteFramebuffer(i), (i.name = 0), (Ue.framebuffers[n] = null));
                    }
                },
                emscripten_glDeleteProgram: function (e) {
                    if (e) {
                        var r = Ue.programs[e];
                        r ? (jr.deleteProgram(r), (r.name = 0), (Ue.programs[e] = null), (Ue.programInfos[e] = null)) : Ue.recordError(1281);
                    }
                },
                emscripten_glDeleteQueries: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        var n = q[(r + 4 * t) >> 2],
                            i = Ue.queries[n];
                        i && (jr.deleteQuery(i), (Ue.queries[n] = null));
                    }
                },
                emscripten_glDeleteQueriesEXT: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        ...
                        i && (jr.disjointTimerQueryExt.deleteQueryEXT(i), (Ue.timerQueriesEXT[n] = null));
                    }
                },
                emscripten_glDeleteRenderbuffers: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        ...
                        i && (jr.deleteRenderbuffer(i), (i.name = 0), (Ue.renderbuffers[n] = null));
                    }
                },
                emscripten_glDeleteSamplers: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        var n = q[(r + 4 * t) >> 2],
                            i = Ue.samplers[n];
                        i && (jr.deleteSampler(i), (i.name = 0), (Ue.samplers[n] = null));
                    }
                },
                emscripten_glDeleteShader: function (e) {
                    if (e) {
                        var r = Ue.shaders[e];
                        r ? (jr.deleteShader(r), (Ue.shaders[e] = null)) : Ue.recordError(1281);
                    }
                },
                emscripten_glDeleteSync: function (e) {
                    if (e) {
                        var r = Ue.syncs[e];
                        r ? (jr.deleteSync(r), (r.name = 0), (Ue.syncs[e] = null)) : Ue.recordError(1281);
                    }
                },
                emscripten_glDeleteTextures: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        var n = q[(r + 4 * t) >> 2],
                            i = Ue.textures[n];
                        i && (jr.deleteTexture(i), (i.name = 0), (Ue.textures[n] = null));
                    }
                },
                emscripten_glDeleteTransformFeedbacks: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        ...
                        i && (jr.deleteTransformFeedback(i), (i.name = 0), (Ue.transformFeedbacks[n] = null));
                    }
                },
                emscripten_glDeleteVertexArrays: function (e, r) {
                    for (var t = 0; t < e; t++) {
                        var n = q[(r + 4 * t) >> 2];
                        jr.deleteVertexArray(Ue.vaos[n]), (Ue.vaos[n] = null);
                    }
                },
                    ...
                    if (n)
                        switch (((e = Ue.programs[e]), t)) {
                            ...
                            default:
                                ...
                                else for (var o = 0; o < a.length; o++) q[(n + 4 * o) >> 2] = a[o];
                        }
                    else Ue.recordError(1281);
                },
                ...
                emscripten_glGetInternalformativ: function (e, r, t, n, i) {
                    if (n < 0) Ue.recordError(1281);
                        ...
                        if (null !== a) for (var o = 0; o < a.length && o < n; ++o) q[(i + o) >> 2] = a[o];
                    } else Ue.recordError(1281);
                },
                    ...
                    if (t)
                        if (e >= Ue.counter) Ue.recordError(1281);
                            ...
                            if (n)
                                ...
                                } else q[t >> 2] = jr.getProgramParameter(Ue.programs[e], r);
                ...
                emscripten_glGetSamplerParameterfv: function (e, r, t) {
                    t ? ((e = Ue.samplers[e]), (V[t >> 2] = jr.getSamplerParameter(e, r))) : Ue.recordError(1281);
                },
                emscripten_glGetSamplerParameteriv: function (e, r, t) {
                    t ? ((e = Ue.samplers[e]), (q[t >> 2] = jr.getSamplerParameter(e, r))) : Ue.recordError(1281);
                },
                ...
                emscripten_glGetShaderiv: function (e, r, t) {
                    if (t)
                        if (35716 == r) {
                            ...
                            q[t >> 2] = a;
                        } else q[t >> 2] = jr.getShaderParameter(Ue.shaders[e], r);
                    else Ue.recordError(1281);
                },
                    ...
                    switch (e) {
                        case 7939:
                            ...
                            return (
                                ...
                                r < 0 || r >= t.length ? (Ue.recordError(1281), 0) : t[r]
                            );
                        default:
                            return Ue.recordError(1280), 0;
                    }
                ...
                emscripten_glReadPixels: function (e, r, t, n, i, a, o) {
                    if (Ue.currentContext.version >= 2)
                        if (jr.currentPixelPackBufferBinding) jr.readPixels(e, r, t, n, i, a, o);
                        else {
                            var u = dr(a);
                ...
                emscripten_glTexImage2D: function (e, r, t, n, i, a, o, u, s) {
                    if (Ue.currentContext.version >= 2)
                        if (jr.currentPixelUnpackBufferBinding) jr.texImage2D(e, r, t, n, i, a, o, u, s);
                        else if (s) {
                            var c = dr(u);
                            jr.texImage2D(e, r, t, n, i, a, o, u, c, s >> mr(c));
                        } else jr.texImage2D(e, r, t, n, i, a, o, u, null);
                    else jr.texImage2D(e, r, t, n, i, a, o, u, s ? pr(u, o, n, i, s) : null);
                },
                emscripten_glTexImage3D: function (e, r, t, n, i, a, o, u, s, c) {
                    if (jr.currentPixelUnpackBufferBinding) jr.texImage3D(e, r, t, n, i, a, o, u, s, c);
                    else if (c) {
                        var l = dr(s);
                        jr.texImage3D(e, r, t, n, i, a, o, u, s, l, c >> mr(l));
                    } else jr.texImage3D(e, r, t, n, i, a, o, u, s, null);
                },
                ...
                emscripten_glTexSubImage2D: function (e, r, t, n, i, a, o, u, s) {
                    if (Ue.currentContext.version >= 2)
                        if (jr.currentPixelUnpackBufferBinding) jr.texSubImage2D(e, r, t, n, i, a, o, u, s);
                        else if (s) {
                            var c = dr(u);
                            jr.texSubImage2D(e, r, t, n, i, a, o, u, c, s >> mr(c));
                        } else jr.texSubImage2D(e, r, t, n, i, a, o, u, null);
                    else {
                        var l = null;
                        s && (l = pr(u, o, i, a, s)), jr.texSubImage2D(e, r, t, n, i, a, o, u, l);
                    }
                },
                emscripten_glTexSubImage3D: function (e, r, t, n, i, a, o, u, s, c, l) {
                    if (jr.currentPixelUnpackBufferBinding) jr.texSubImage3D(e, r, t, n, i, a, o, u, s, c, l);
                    else if (l) {
                        var f = dr(c);
                        jr.texSubImage3D(e, r, t, n, i, a, o, u, s, c, f, l >> mr(f));
                    } else jr.texSubImage3D(e, r, t, n, i, a, o, u, s, c, null);
                },
                ...
                emscripten_glUniform1fv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform1fv(Ue.uniforms[e], V, t >> 2, r);
                    else {
                        if (r <= Ue.MINI_TEMP_BUFFER_SIZE) for (var n = Ue.miniTempBufferFloatViews[r - 1], i = 0; i < r; ++i) n[i] = V[(t + 4 * i) >> 2];
                ...
                emscripten_glUniform1iv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform1iv(Ue.uniforms[e], q, t >> 2, r);
                    else {
                        if (r <= Ue.MINI_TEMP_BUFFER_SIZE) for (var n = Ue.miniTempBufferIntViews[r - 1], i = 0; i < r; ++i) n[i] = q[(t + 4 * i) >> 2];
                ...
                emscripten_glUniform2fv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform2fv(Ue.uniforms[e], V, t >> 2, 2 * r);
                    else {
                        if (2 * r <= Ue.MINI_TEMP_BUFFER_SIZE) for (var n = Ue.miniTempBufferFloatViews[2 * r - 1], i = 0; i < 2 * r; i += 2) (n[i] = V[(t + 4 * i) >> 2]), (n[i + 1] = V[(t + (4 * i + 4)) >> 2]);
                ...
                emscripten_glUniform2iv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform2iv(Ue.uniforms[e], q, t >> 2, 2 * r);
                    else {
                        if (2 * r <= Ue.MINI_TEMP_BUFFER_SIZE) for (var n = Ue.miniTempBufferIntViews[2 * r - 1], i = 0; i < 2 * r; i += 2) (n[i] = q[(t + 4 * i) >> 2]), (n[i + 1] = q[(t + (4 * i + 4)) >> 2]);
                ...
                emscripten_glUniform3fv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform3fv(Ue.uniforms[e], V, t >> 2, 3 * r);
                    else {
                ...
                emscripten_glUniform3iv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform3iv(Ue.uniforms[e], q, t >> 2, 3 * r);
                    else {
                        if (3 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                ...
                emscripten_glUniform4fv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform4fv(Ue.uniforms[e], V, t >> 2, 4 * r);
                    else {
                ...
                emscripten_glUniform4iv: function (e, r, t) {
                    if (Ue.currentContext.version >= 2) jr.uniform4iv(Ue.uniforms[e], q, t >> 2, 4 * r);
                    else {
                        if (4 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                            for (var n = Ue.miniTempBufferIntViews[4 * r - 1], i = 0; i < 4 * r; i += 4)
                                (n[i] = q[(t + 4 * i) >> 2]), (n[i + 1] = q[(t + (4 * i + 4)) >> 2]), (n[i + 2] = q[(t + (4 * i + 8)) >> 2]), (n[i + 3] = q[(t + (4 * i + 12)) >> 2]);
                ...
                emscripten_glUniformBlockBinding: function (e, r, t) {
                    (e = Ue.programs[e]), jr.uniformBlockBinding(e, r, t);
                },
                emscripten_glUniformMatrix2fv: function (e, r, t, n) {
                    if (Ue.currentContext.version >= 2) jr.uniformMatrix2fv(Ue.uniforms[e], !!t, V, n >> 2, 4 * r);
                    else {
                        if (4 * r <= Ue.MINI_TEMP_BUFFER_SIZE)
                            for (var i = Ue.miniTempBufferFloatViews[4 * r - 1], a = 0; a < 4 * r; a += 4)
                                (i[a] = V[(n + 4 * a) >> 2]), (i[a + 1] = V[(n + (4 * a + 4)) >> 2]), (i[a + 2] = V[(n + (4 * a + 8)) >> 2]), (i[a + 3] = V[(n + (4 * a + 12)) >> 2]);
                ...
                emscripten_glUniformMatrix3fv: function (e, r, t, n) {
                    if (Ue.currentContext.version >= 2) jr.uniformMatrix3fv(Ue.uniforms[e], !!t, V, n >> 2, 9 * r);
                    else {
                ...
                emscripten_glUniformMatrix4fv: function (e, r, t, n) {
                    if (Ue.currentContext.version >= 2) jr.uniformMatrix4fv(Ue.uniforms[e], !!t, V, n >> 2, 16 * r);
                    else {
                            ...
                            i = (function (e, r) {
                                ...
                                function i(e) {
                                    ...
                                    return (
                                        ...
                                        "double" === e ? ((r = X[n >> 3]), (n += 8)) : "i64" == e ? ((r = [q[n >> 2], q[(n + 4) >> 2]]), (n += 8)) : ((e = "i32"), (r = q[n >> 2]), (n += 4)),
                                        r
                                    );
                                }
                                for (var a, o, u, s, c = []; ; ) {
                                    ...
                                    if (((o = j[(t + 1) >> 0]), 37 == a)) {
                                        ...
                                        var g = 0;
                                        if (42 == o) (g = i("i32")), t++, (o = j[(t + 1) >> 0]);
                                        else for (; o >= 48 && o <= 57; ) (g = 10 * g + (o - 48)), t++, (o = j[(t + 1) >> 0]);
                                        var _,
                                            h = !1,
                                            b = -1;
                                        if (46 == o) {
                                            if (((b = 0), (h = !0), t++, 42 == (o = j[(t + 1) >> 0]))) (b = i("i32")), t++;
                                            else
                                                for (;;) {
                                                    var y = j[(t + 1) >> 0];
                                                    if (y < 48 || y > 57) break;
                                        ...
                                        switch ((b < 0 && ((b = 6), (h = !1)), String.fromCharCode(o))) {
                                            case "h":
                                                104 == j[(t + 2) >> 0] ? (t++, (_ = 1)) : (_ = 2);
                                                break;
                                            case "l":
                                                108 == j[(t + 2) >> 0] ? (t++, (_ = 8)) : (_ = 4);
                                                break;
                                            case "L":
                                            case "q":
                                            case "j":
                                        ...
                                        switch ((_ && t++, (o = j[(t + 1) >> 0]), String.fromCharCode(o))) {
                                            case "d":
                                            case "i":
                                            case "u":
                                            case "o":
                                            ...
                                            case "p":
                                                var w = 100 == o || 105 == o;
                                                (u = i("i" + 8 * (_ = _ || 4))), 8 == _ && (u = 117 == o ? (u[0] >>> 0) + 4294967296 * (u[1] >>> 0) : rr(u[0], u[1])), _ <= 4 && (u = (w ? ie : ne)(u & (Math.pow(256, _) - 1), 8 * _));
                                                var E = Math.abs(u),
                                                    x = "";
                                                if (100 == o || 105 == o) S = ie(u, 8 * _).toString(10);
                                                else if (117 == o) (S = ne(u, 8 * _).toString(10)), (u = Math.abs(u));
                                                else if (111 == o) S = (m ? "0" : "") + E.toString(8);
                                                else if (120 == o || 88 == o) {
                                                    if (((x = m && 0 != u ? "0x" : ""), u < 0)) {
                                                        (u = -u), (S = (E - 1).toString(16));
                                                        for (var k = [], C = 0; C < S.length; C++) k.push((15 - parseInt(S[C], 16)).toString(16));
                                                        for (S = k.join(""); S.length < 2 * _; ) S = "f" + S;
                                                    } else S = E.toString(16);
                                                    88 == o && ((x = x.toUpperCase()), (S = S.toUpperCase()));
                                                } else 112 == o && (0 === E ? (S = "(nil)") : ((x = "0x"), (S = E.toString(16))));
                                                if (h) for (; S.length < b; ) S = "0" + S;
                                                for (u >= 0 && (f ? (x = "+" + x) : v && (x = " " + x)), "-" == S.charAt(0) && ((x = "-" + x), (S = S.substr(1))); x.length + S.length < g; )
                                                    d ? (S += " ") : p ? (S = "0" + S) : (x = " " + x);
                                            ...
                                            case "G":
                                                ...
                                                if (((u = i("double")), isNaN(u))) (S = "nan"), (p = !1);
                                                    ...
                                                    101 == o || 69 == o
                                                        ? ((S = u.toExponential(F)), /[eE][-+]\d$/.test(S) && (S = S.slice(0, -1) + "0" + S.slice(-1)))
                                                        : (102 != o && 70 != o) || ((S = u.toFixed(F)), 0 === u && ((s = u) < 0 || (0 === s && 1 / s == -1 / 0)) && (S = "-" + S));
                                                    var P = S.split("e");
                                                    if (D && !m) for (; P[0].length > 1 && -1 != P[0].indexOf(".") && ("0" == P[0].slice(-1) || "." == P[0].slice(-1)); ) P[0] = P[0].slice(0, -1);
                                                    else for (m && -1 == S.indexOf(".") && (P[0] += "."); b > F++; ) P[0] += "0";
                                            ...
                                            case "s":
                                                ...
                                                if ((h && (L = Math.min(L, b)), !d)) for (; L < g--; ) c.push(32);
                                                if (T) for (C = 0; C < L; C++) c.push(O[T++ >> 0]);
                                                else c = c.concat(Qr("(null)".substr(0, L), !0));
                                                if (d) for (; L < g--; ) c.push(32);
                                                break;
                                            case "c":
                ...
                emscripten_request_fullscreen_strategy: function (e, r, t) {
                    return (function (e, r) {
                        return je.fullscreenEnabled()
                            ? (e = ze(e))
                                ? e.requestFullscreen || e.webkitRequestFullscreen
                                    ? je.canPerformEventHandlerRequests()
                                        ? Ke(e, r)
                                        : r.deferUntilInEventHandler
                                        ? (je.deferCall(Ke, 1, [e, r]), 1)
                                        : -2
                                    : -3
                                : -4
                            : -1;
                ...
                emscripten_request_pointerlock: function (e, r) {
                    return (e = ze(e)) ? (e.requestPointerLock || e.msRequestPointerLock ? (je.canPerformEventHandlerRequests() ? $e(e) : r ? (je.deferCall($e, 2, [e]), 1) : -2) : -1) : -4;
                },
                emscripten_resize_heap: function (e) {
                    ...
                    for (var n, i, a = 1; a <= 4; a *= 2) {
                        var o = r * (1 + 0.2 / a);
                        if (((o = Math.min(o, e + 100663296)), hr(Math.min(t, ((n = Math.max(16777216, e, o)) % (i = 65536) > 0 && (n += i - (n % i)), n))))) return !0;
                    }
                    return !1;
                },
                ...
                emscripten_set_fullscreenchange_callback_on_thread: function (e, r, t, n, i) {
                    return je.fullscreenEnabled() ? ((e = ze(e)) ? (yr(e, r, t, n, 19, "fullscreenchange"), yr(e, r, t, n, 19, "webkitfullscreenchange"), 0) : -4) : -1;
                },
                ...
                emscripten_set_pointerlockchange_callback_on_thread: function (e, r, t, n, i) {
                    return document && document.body && (document.body.requestPointerLock || document.body.mozRequestPointerLock || document.body.webkitRequestPointerLock || document.body.msRequestPointerLock)
                        ? (e = ze(e))
                            ? (Cr(e, r, t, n, 20, "pointerlockchange"), Cr(e, r, t, n, 20, "mozpointerlockchange"), Cr(e, r, t, n, 20, "webkitpointerlockchange"), Cr(e, r, t, n, 20, "mspointerlockchange"), 0)
                            : -4
                        : -1;
                },
                emscripten_set_resize_callback_on_thread: function (e, r, t, n, i) {
                    return (
                        (function (e, r, t, n, i, a, o) {
                ...
                emscripten_set_visibilitychange_callback_on_thread: function (e, r, t, n) {
                    return Dr(Ge[1], e, r, t, 21, "visibilitychange"), 0;
                },
                ...
                environ_get: function (e, r) {
                    ...
                    return (
                        Ir().forEach(function (n, i) {
                            ...
                            (q[(e + 4 * i) >> 2] = a),
                                (function (e, r, t) {
                                    for (var n = 0; n < e.length; ++n) j[r++ >> 0] = e.charCodeAt(n);
                                    t || (j[r >> 0] = 0);
                                })(n, a),
                                (t += n.length + 1);
                        }),
                ...
                fd_seek: function (e, r, t, n, i) {
                    try {
                        ...
                        return o <= -u || o >= u
                            ? -61
                            : (Pe.llseek(a, o, n),
                              (he = [a.position >>> 0, ((_e = a.position), +ae(_e) >= 1 ? (_e > 0 ? (0 | se(+ue(_e / 4294967296), 4294967295)) >>> 0 : ~~+oe((_e - +(~~_e >>> 0)) / 4294967296) >>> 0) : 0)]),
                              (q[i >> 2] = he[0]),
                              (q[(i + 4) >> 2] = he[1]),
                ...
                round: function (e) {
                    return (e = +e) >= 0 ? +ue(e + 0.5) : +oe(e - 0.5);
                },
                saveSetjmp: function e(r, t, n, i) {
                    (t |= 0), (n |= 0), (i |= 0);
                    var a = 0;
                    for (_r = (_r + 1) | 0, q[(r |= 0) >> 2] = _r; (0 | a) < (0 | i); ) {
                        if (0 == (0 | q[(n + (a << 3)) >> 2])) return (q[(n + (a << 3)) >> 2] = _r), (q[(n + (4 + (a << 3))) >> 2] = t), (q[(n + (8 + (a << 3))) >> 2] = 0), x(0 | i), 0 | n;
                        a = (a + 1) | 0;
                    }
                            ...
                            if ("insertCompositionText" != e.inputType || e.isComposing) {
                                if ("deleteContentForward" == e.inputType || ("insertText" == e.inputType && null == e.data)) m(l.wafSelectionStart, l.wafSelectionEnd + 1);
                                    ...
                                    let t = l.wafSelectionStart,
                                        n = l.wafSelectionEnd;
                                    e.isComposing ? (f ? ((l.wafSelectionEnd = ++l.wafSelectionStart), (f = !1)) : (t -= 1), r || (l.wafSelectionEnd = --l.wafSelectionStart)) : (l.wafSelectionEnd = ++l.wafSelectionStart),
                                        ((e, r, t) => {
                                            const n = R(e) + 1,
                                                i = Zr(n);
            ...
            Xr = (function () {
                ...
                function i(r) {
                    return (b || "function" != typeof fetch
                        ...
                        : fetch(be, { credentials: "same-origin" })
                              .then(function (e) {
                ...
                return (
                    (function () {
                        ...
                        fetch(be, { credentials: "same-origin" }).then(function (r) {
        ...
        r.asm = Xr;
        var Hr,
            Wr = (r.___wasm_call_ctors = function () {
            ...
            Kr =
                ((r.___em_js__wafjs_url_transformRequestUrl = function () {
        ...
        function kt(e) {
            function n() {
                Hr ||
                    ...
                    S ||
                        ...
                        (function () {
                            if (r.postRun) for ("function" == typeof r.postRun && (r.postRun = [r.postRun]); r.postRun.length; ) (e = r.postRun.shift()), re.unshift(e);
                            var e;
                            Z(re);
                        })()));
            }
            (e = e || c),
                ce > 0 ||
                    (!(function () {
                        if (r.preRun) for ("function" == typeof r.preRun && (r.preRun = [r.preRun]); r.preRun.length; ) (e = r.preRun.shift()), K.unshift(e);
                        var e;
                        Z(K);
                    })(),
                    ce > 0 ||
