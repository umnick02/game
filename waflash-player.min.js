import createWaflashModule from "./waflash.min.js?2022012701";
const WAFLASH_BASE_URL = "https://sithisdev.github.io/Waflash2/",
    createWaflash = (t, e) => {
        ...
        let a = {
            ...
            preRun: [],
            postRun: [],
            locateFile: (t, e) => WAFLASH_BASE_URL + t + "?2022012701",
            print(t) {
                console.log(t);
            },
            printErr(t) {
                ...
                hal: {
                    url_transformRequestUrl(t) {
                        ...
                        const n = (function (t) {
                            ...
                            return [".kakaocdn.net", ".akaocdn.net", ".a.github.io", ".github.io", ".waflash.io", "waflash.cdn.ntruss.com", ".f-igri.ru", "en.f-igri.ru", "f-igri.ru"].some((e) => t.indexOf(e) > 0) ? t.replace("http://", "http://") : null;
                        })(t);
        ...
        (window.waflash = a),
            (window.onerror = (t, e, n, s, o) => {
                ...
                a.ga && a.ga("event", document.location.origin, { event_category: "error", event_label: r, non_interaction: !0, send_to: a.gid });
            }),
